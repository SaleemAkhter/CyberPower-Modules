...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ModuleConstants;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
     ...
     * @param string $key
     * @return $this
     * @throws \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Exceptions\MGModuleException
     */
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
