...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Hook\Interfaces\InternalHook;
...
class InternalHooksWrapper
{
    ...
    {
        $fullInstanceName =  '\ModulesGarden\Servers\GoogleCloudVirtualMachines\App\Hooks\InternalHooks\\' . $name;
