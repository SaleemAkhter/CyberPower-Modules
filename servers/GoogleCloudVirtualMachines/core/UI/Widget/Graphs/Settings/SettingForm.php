...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Graphs\Settings;
...
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Forms\Fields\Number;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Forms\Fields\Select2vueByValueOnly;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Forms\Fields\ColorPicker;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Graphs\EmptyGraph;
...
class SettingForm extends BaseForm
{
    ...
    protected $providerClass    = 'ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Graphs\Settings\SettingDataProvider';
