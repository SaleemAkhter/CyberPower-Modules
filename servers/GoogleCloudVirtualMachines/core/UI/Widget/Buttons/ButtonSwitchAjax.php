...
class ButtonSwitchAjax extends ButtonCustomAction implements AjaxElementInterface
{
    ...
    {
        if ($model instanceof \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Models\ExtendedEloquentModel || $model instanceof \Illuminate\Database\Eloquent\Model)
        {
