...
class ButtonDownloadRedirect extends BaseContainer
{
    ...
    protected $iconFileName   = 'DownloadRdpFile.png';
    ...
    {
        $this->htmlAttributes['@click.middle'] = 'redirectRdp($event, ' . $this->parseCustomParams() . ', true)';
        $this->htmlAttributes['@click'] = 'redirectRdp($event, ' . $this->parseCustomParams() . ')';
    }
