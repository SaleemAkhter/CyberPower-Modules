 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Form;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Fields;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Sections;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\FormDataProvider;
