...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Forms\Sections;
...
class BaseSection extends BaseContainer
{
    ...
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Section;
