...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\DataTable;

use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Builder\BaseContainer;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\DataTable\DataProviders;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\ResponseTemplates;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\DependencyInjection\DependencyInjection;
 ...
 * @author inbs
 */
class DataTable extends BaseContainer implements \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\VSortable;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\TableLength;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Datatable\Filters;
    ...
    */
    ...
    public function setData(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Interfaces\DataSetInterface $data)
    {
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
