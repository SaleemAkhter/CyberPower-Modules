...
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
