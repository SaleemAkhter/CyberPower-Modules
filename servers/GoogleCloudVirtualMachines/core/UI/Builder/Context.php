...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Builder;
...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Title;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Template;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Searchable;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Buttons;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Icon;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\VueComponent;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\ACL;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\Alerts;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\WidgetView;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Traits\ContainerElements;
    ...
    /**
     * @param \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Builder\Context $object
     * @return string
     */
