...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Helpers;
...
class BreadcrumbsHandler
{
    ...
    {
        $this->breadcrumbs[] = new \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Helpers\Breadcrumb(
    ...
    public function loadDefault()
    {
        ...
        $router = new \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Router();
        if ($this->isAdmin())
        {
