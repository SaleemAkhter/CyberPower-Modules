...
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
