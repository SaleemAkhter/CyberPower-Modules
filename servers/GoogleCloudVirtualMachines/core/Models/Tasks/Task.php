...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Models\Tasks;
 ...
 * @property $namespace
 * @property $rel_id
 * @package ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Models\Tasks
 */
