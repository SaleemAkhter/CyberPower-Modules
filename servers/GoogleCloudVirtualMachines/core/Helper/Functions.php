...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Events\Dispatcher;
...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Cache\CacheManager;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Logger\Entity;

if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\json'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\response'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Http\Response
     */
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\cache'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Interfaces\CacheManagerInterface
     */
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\redirect'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\redirectByUrl'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\t'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\errorLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\successLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\infoLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\criticalLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\debugLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\sl'))
{

    /**
     * @param string $class
     * @param string|null $method
     * @return object|ApiClient|Lang
     */
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\di'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\isAdmin'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\getAdminDirName'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\getModuleName'))
{
    ...
    function getModuleName()
    {
        ...
        if (isAdmin())
        {
            $data = $request->get('module', $request->query->get('module', 'GoogleCloudVirtualMachines'));
            return isset($data) ? $data : '';
        }

        $data = $request->get('m', $request->query->get('m', 'GoogleCloudVirtualMachines'));
        return isset($data) ? $data : '';
    }
}

if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\view'))
{

    /**
     * main View Controler
     * 
     * @return \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\View
     */
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\viewIntegrationAddon'))
{
    /**
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\convertStringToNamespace'))
{
...
if (!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\getRequest'))
{
    function getRequest()
    {
        return sl(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Http\Request::class);
    }
}

if(!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\fire'))
{
    /**
     * Fire event!
     * @param $event
...
if(!function_exists('\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Helper\queue'))
{
