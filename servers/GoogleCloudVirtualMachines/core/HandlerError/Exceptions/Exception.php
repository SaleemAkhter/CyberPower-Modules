...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Exceptions;

use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ServiceLocator;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\ErrorManager;
...
class Exception extends \Exception
{
    ...
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Traits\IsDebugOn;
     ...
     * 
     * @var type \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\ErrorCodes\ErrorCode
     */
