...
use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\HandlerError\Logger
     */
