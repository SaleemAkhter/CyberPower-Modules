...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Queue\Services;


use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Queue\Models\JobLog;
...
class Log
{
    ...
    public function __construct(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Queue\Models\Job $job)
    {
        $this->job  = $job;
    }
