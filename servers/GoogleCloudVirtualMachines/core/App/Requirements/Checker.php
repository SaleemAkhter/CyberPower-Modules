...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\FileReader\|\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\DependencyInjection\DependencyInjection::call($requirement);
