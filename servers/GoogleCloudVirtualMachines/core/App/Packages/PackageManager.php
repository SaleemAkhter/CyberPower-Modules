...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\FileReader\Directory;
...
class PackageManager
{
    ...
    public function getPackageListByDirectory()
    {
        ...
        {
            $className = '\ModulesGarden\Servers\GoogleCloudVirtualMachines\Packages\\' . $packageName . '\Config\PackageConfiguration';
