...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Router;
...
abstract class HttpController implements DefaultController
{
    ...
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Traits\Params;
