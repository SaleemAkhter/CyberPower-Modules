...
namespace ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Instances;

use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Http\PageNotFound;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Interfaces\DefaultController;
...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\ViewAjax;
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\UI\ViewIntegrationAddon;
...
abstract class AddonController implements DefaultController
{
    ...
    use \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Traits\ErrorCodesLibrary;
    ...
    protected function getIntegrationControler($action = null)
    {
        ...
        {
            case 'ConfigOptions':
                return Helper\di(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Instances\Http\ConfigOptionsIntegration::class);
                break;
            case 'AdminServicesTabFields':
                return Helper\di(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Instances\Http\AdminServicesTabFieldsIntegration::class);
                break;
            default:
                return Helper\di(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\Instances\Http\AddonIntegration::class);
        }
    }
