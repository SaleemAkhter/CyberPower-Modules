...
use ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\Http\View\Smarty;
...
class Response extends SymfonyRespose
{
    ...
    /**
     * @param $responseResolver \ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\App\Controllers\ResponseResolver
     */
    ...
    public function returnClientAddon($vars, $path, $fileName)
    {
        return [
            'vars' => $vars,
            'templatefile' => str_replace(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
    ...
    public function returnClientProvisioning($vars, $path, $fileName)
    {
        ...
        return [
            $templateVarName => str_replace(\ModulesGarden\Servers\GoogleCloudVirtualMachines\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
                '', $path . DIRECTORY_SEPARATOR . $fileName),
