{**********************************************************************
* GoogleCloudVirtualMachines product developed. (2017-08-31)
* *
*
...
{literal}
    <div data-toggler-options="toggleClass: is-open" class="lu-input-group lu-input-group--toggle">
        <input type="text" data-toggler-options="toggleClass: hidden" placeholder="{/literal}{$MGLANG->absoluteT('searchPlacecholder')}{literal}" class="lu-form-control hidden" @keydown.enter="searchDataEnter">
