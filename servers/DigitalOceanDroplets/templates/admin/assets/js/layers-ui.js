...
(function (root, factory) {
  ...
  */
	...
	var Selectize = function Selectize($input, settings) {
		...
		$.extend(self, {
			...
			eventNS: '.luselectize' + ++Selectize.count,
   ...
   * luselectize options that should provide the data
   ...
   */
		destroy: function destroy() {
			...
			self.$input.removeData('luselectize');

			$(window).off(eventNS);
			$(document).off(eventNS);
			$(document.body).off(eventNS);

			delete self.$input[0].luselectize;
		},
   ...
   */
	...
	Selectize.defaults = {
		...
		mode: null,
		wrapperClass: 'luselectize-control',
		inputClass: 'luselectize-input',
		dropdownClass: 'luselectize-dropdown',
		dropdownContentClass: 'luselectize-dropdown-content',
  ...
  */
   ...
   */
	...
	$.fn.luselectize = function (settings_user) {
		var defaults = $.fn.luselectize.defaults;
		...
		/**
   * Initializes luselectize from a <input type="text"> element.
   *
   * @param {object} $input
   ...
   */
		...
		/**
   * Initializes luselectize from a <select> element.
   *
   * @param {object} $input
   * @param {object} settings_element
   */
	...
	$.fn.luselectize.defaults = Selectize.defaults;
	$.fn.luselectize.support = {
	...
	Selectize.define('dropdown_header', function (options) {
		...
		options = $.extend({
			title: 'Untitled',
			headerClass: 'luselectize-dropdown-header',
			titleRowClass: 'luselectize-dropdown-header-title',
			labelClass: 'luselectize-dropdown-header-label',
			closeClass: 'luselectize-dropdown-header-close',
