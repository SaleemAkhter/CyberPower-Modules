...
use ModulesGarden\Servers\DigitalOceanDroplets\Core\Models\Whmcs as wModels;
...
class Lang
{
    ...
    private function __construct($dir = null, $lang = null)
    {
        ...
        {
            $data          = new \ModulesGarden\Servers\DigitalOceanDroplets\Core\Configuration\Data();
     ...
     * @param type $dir
     * @param type $lang
     * @return \ModulesGarden\Servers\DigitalOceanDroplets\Core\Helper\Lang
     */
