...
use ModulesGarden\Servers\DigitalOceanDroplets\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Logger
     */
    ...
    public function __call($name, $arguments)
    {
        ...
        throw new \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Exceptions\MGModuleException(self::class, "Method `{$name}` is not exists.");
    }
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Logger
     */
