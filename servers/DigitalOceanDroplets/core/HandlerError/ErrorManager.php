...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\WhmcsRegisterLoggin
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\Servers\DigitalOceanDroplets\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\WhmcsRegisterLoggin
     */
    ...
    {
        return new \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Model\Warning $warning)
    {
