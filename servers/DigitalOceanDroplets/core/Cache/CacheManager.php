<?php
namespace ModulesGarden\Servers\DigitalOceanDroplets\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\DigitalOceanDroplets\Core\ModuleConstants;
use ModulesGarden\Servers\DigitalOceanDroplets\Core\Interfaces\CacheManagerInterface;
/**
...
class CacheManager implements CacheManagerInterface
{
    ...
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\DigitalOceanDroplets\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
