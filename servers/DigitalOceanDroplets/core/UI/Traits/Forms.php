...
use \ModulesGarden\Servers\DigitalOceanDroplets\Core\UI\Interfaces\FormInterface;
...
trait Forms
{
    ...
    public function addForm(FormInterface $form)
    {
        ...
        if ($form instanceof \ModulesGarden\Servers\DigitalOceanDroplets\Core\UI\Interfaces\AjaxElementInterface)
        {
