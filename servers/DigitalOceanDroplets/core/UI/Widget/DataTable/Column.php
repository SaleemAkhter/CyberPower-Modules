...
use \ModulesGarden\Servers\DigitalOceanDroplets\Core\UI\Widget\DataTable\DataProviders\DataProvider;
...
class Column
{
    ...
    public function setFilter(\ModulesGarden\Servers\DigitalOceanDroplets\Core\UI\Widget\DataTable\Filters $filter)
    {
        $this->filter = $filter;
