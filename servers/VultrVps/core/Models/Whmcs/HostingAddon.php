...
class HostingAddon extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\VultrVps\Core\Models\Whmcs\Addon", "addonid");
    }

    public function hosting()
    {
        return $this->belongsTo("ModulesGarden\Servers\VultrVps\Core\Models\Whmcs\Hosting", "hostingid");
    }
