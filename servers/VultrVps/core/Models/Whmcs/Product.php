...
class Product extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\VultrVps\Core\Models\Whmcs\ProductGroup", "gid");
    }

    public function upgrades()
    {
        return $this->hasMany("ModulesGarden\Servers\VultrVps\Core\Models\Whmcs\ProductUpgrade", "product_id");
    }
}
