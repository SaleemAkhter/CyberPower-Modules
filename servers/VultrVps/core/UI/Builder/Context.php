...
namespace ModulesGarden\Servers\VultrVps\Core\UI\Builder;

use ModulesGarden\Servers\VultrVps\Core\Helper\BuildUrl;
use ModulesGarden\Servers\VultrVps\Core\ServiceLocator;
use ModulesGarden\Servers\VultrVps\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Title;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Template;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Searchable;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Buttons;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Icon;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\VueComponent;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\ACL;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Alerts;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\WidgetView;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\ContainerElements;
    ...
    /**
     * @param \ModulesGarden\Servers\VultrVps\Core\UI\Builder\Context $object
     * @return string
     */
