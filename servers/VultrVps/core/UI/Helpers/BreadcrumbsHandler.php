...
namespace ModulesGarden\Servers\VultrVps\Core\UI\Helpers;
...
class BreadcrumbsHandler
{
    ...
    {
        $this->breadcrumbs[] = new \ModulesGarden\Servers\VultrVps\Core\UI\Helpers\Breadcrumb(
    ...
    public function loadDefault()
    {
        ...
        $router = new \ModulesGarden\Servers\VultrVps\Core\App\Controllers\Router();
        if ($this->isAdmin())
        {
