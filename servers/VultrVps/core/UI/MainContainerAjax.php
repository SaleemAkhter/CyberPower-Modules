...
use ModulesGarden\Servers\VultrVps\Core\UI\Builder\Config;
use ModulesGarden\Servers\VultrVps\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\Servers\VultrVps\Core\Helper\sl('request')->get('index');
    ...
    public function addElement($element)
    {
        ...
        if (!isset($this->ajaxElements[$id]))
        {
            ...
            if ($element instanceof \ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\AjaxElementInterface)
            {
    ...
    public function addAjaxElement(\ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
