 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Form;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Fields;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Sections;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\FormDataProvider;
    ...
    public function returnAjaxData()
    {
        ...
        if ($response instanceof \ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\ResponseInterface)
        {
            return $response;
        }
