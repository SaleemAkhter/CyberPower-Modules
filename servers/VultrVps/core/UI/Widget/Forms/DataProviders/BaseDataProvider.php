...
namespace ModulesGarden\Servers\VultrVps\Core\UI\Widget\Forms\DataProviders;

use ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\FormDataProviderInterface;
...
abstract class BaseDataProvider implements FormDataProviderInterface
{
    ...
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\RequestFormDataHandler;
    ...
    {
        if (is_array($this->availableValues[$id]) || (is_object($this->availableValues) && count($this->availableValues[$id]) > 0))
        {
