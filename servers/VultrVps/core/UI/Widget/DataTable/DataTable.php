...
namespace ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable;

use ModulesGarden\Servers\VultrVps\Core\DependencyInjection\DependencyInjection;
...
use ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\DataProviders;
 ...
 * @author inbs
 */
class DataTable extends BaseContainer implements \ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\VSortable;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\TableLength;
    use \ModulesGarden\Servers\VultrVps\Core\UI\Traits\Datatable\Filters;
    ...
    */
    ...
    public function setData(\ModulesGarden\Servers\VultrVps\Core\UI\Interfaces\DataSetInterface $data)
    {
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\Servers\VultrVps\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
