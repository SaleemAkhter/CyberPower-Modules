...
use ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
