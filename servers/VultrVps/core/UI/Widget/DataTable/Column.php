...
use ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\DataProviders\DataProvider;
...
class Column
{
    ...
    public function setFilter(\ModulesGarden\Servers\VultrVps\Core\UI\Widget\DataTable\Filters $filter)
    {
        $this->filter = $filter;
