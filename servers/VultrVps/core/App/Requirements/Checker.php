...
namespace ModulesGarden\Servers\VultrVps\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\Servers\VultrVps\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\Servers\VultrVps\Core\FileReader\|\ModulesGarden\Servers\VultrVps\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\Servers\VultrVps\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\Servers\VultrVps\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\Servers\VultrVps\Core\DependencyInjection\DependencyInjection::call($requirement);
