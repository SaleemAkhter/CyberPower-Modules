...
use ModulesGarden\Servers\VultrVps\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\Servers\VultrVps\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\Servers\VultrVps\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\Servers\VultrVps\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\Servers\VultrVps\Core\Configuration\Addon\Config\After::class)->execute($return);
