...
namespace ModulesGarden\Servers\VultrVps\Core\App\Packages;

use ModulesGarden\Servers\VultrVps\Core\FileReader\Directory;
...
class PackageManager
{
    ...
    public function getPackageListByDirectory()
    {
        ...
        {
            $className = '\ModulesGarden\Servers\VultrVps\Packages\\' . $packageName . '\Config\PackageConfiguration';
