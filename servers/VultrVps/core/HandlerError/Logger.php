...
use ModulesGarden\Servers\VultrVps\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\VultrVps\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\Servers\VultrVps\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\VultrVps\Core\HandlerError\Logger
     */
