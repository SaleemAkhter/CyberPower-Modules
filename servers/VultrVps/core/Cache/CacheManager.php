...
namespace ModulesGarden\Servers\VultrVps\Core\Cache;

use ModulesGarden\Servers\VultrVps\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
     ...
     * @param string $key
     * @return $this
     * @throws \ModulesGarden\Servers\VultrVps\Core\HandlerError\Exceptions\MGModuleException
     */
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\VultrVps\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
