...
use ModulesGarden\Servers\VultrVps\Core\Helper\WhmcsVersionComparator;
use ModulesGarden\Servers\VultrVps\Core\Http\View\MainMenu;
use ModulesGarden\Servers\VultrVps\Core\Http\View\Smarty;
...
class Response extends SymfonyRespose
{
    ...
    /**
     * @param $responseResolver \ModulesGarden\Servers\VultrVps\Core\App\Controllers\ResponseResolver
     */
    ...
    public function returnClientAddon($vars, $path, $fileName)
    {
        return [
            'vars' => $vars,
            'templatefile' => str_replace(\ModulesGarden\Servers\VultrVps\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
    ...
    public function returnClientProvisioning($vars, $path, $fileName)
    {
        ...
        return [
            $templateVarName => str_replace(\ModulesGarden\Servers\VultrVps\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
                '', $path . DIRECTORY_SEPARATOR . $fileName),
