...
use ModulesGarden\Servers\VultrVps\Core\Models\ProductSettings\Repository;
use ModulesGarden\Servers\VultrVps\Core\Models\Whmcs\Currency;
...
use ModulesGarden\Servers\VultrVps\Packages\WhmcsService\Traits\CustomFieldsConfig;
...
class Product
{
    ...
    {
        if(!class_exists('\ModulesGarden\Servers\VultrVps\App\Config\Packages\WhmcsService'))
        {
            return null;
        }

        $service = new \ModulesGarden\Servers\VultrVps\App\Config\Packages\WhmcsService();
