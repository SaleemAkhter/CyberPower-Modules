      ...
      var Util = (function () {
        ...
        function setTransitionEndSupport() {
          ...
          if (Util.supportsTransitionEnd()) {
            _jquery2.default.event.special[Util.TRANSITION_END] =
          ...
          [
            {
              ...
              value: function init(container, drop) {
                if (container) {
                  new selectInput(
                    $(container).find(SELECTORS.inputsContainer),
                    drop
                  );
                } else {
        ...
        var Swiper = function Swiper(container, params) {
          ...
          s.initEvents = function (detach) {
            ...
            var touchEventsTarget =
              s.params.touchEventsTarget === "lu-container"
                ? s.container[0]
                : s.wrapper[0];
          ...
          s.lazy = {
            ...
            loadImageInSlide: function loadImageInSlide(
              index,
              loadInDuplicate
            ) {
          ...
          function handleKeyboard(e) {
            ...
            if (kc === 37 || kc === 39 || kc === 38 || kc === 40) {
              ...
              if (
                ...
                s.container.parents("." + s.params.slideActiveClass).length ===
                  0
              ) {
                return;
              }
          ...
          s.zoom = {
            ...
            onTouchMove: function onTouchMove(e) {
              ...
              z.velocity.y =
                ...
                2;
              if (
                Math.abs(z.image.touchesCurrent.x - z.velocity.prevPositionX) <
                2
              )
                z.velocity.x = 0;
              if (
                Math.abs(z.image.touchesCurrent.y - z.velocity.prevPositionY) <
                2
              )
                z.velocity.y = 0;
              z.velocity.prevPositionX = z.image.touchesCurrent.x;
            ...
            attachEvents: function attachEvents(detach) {
              ...
              if (s.params.zoom) {
                ...
                s.slides.each(function (index, slide) {
                  if (
                    $(slide).find("." + s.params.zoomContainerClass).length > 0
                  ) {
                  ...
                  if (
                    ...
                    if (this[j].dom7LiveListeners) {
                      for (
                        ...
                        if (
                          this[j].dom7LiveListeners[k].listener === listener
                        ) {
...
===========================*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      (function (root, factory) {
        if (true) {
          !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(34)]),
                ...
                value: function setupElements() {
                  ...
                  if (typeof this.options.content === "function") {
                    var generateAndSetContent =
                      function generateAndSetContent() {
                        ...
                        if (typeof contentElementOrHTML === "string") {
                          ...
                          (typeof contentElementOrHTML === "undefined"
                            ? "undefined"
                            : _typeof(contentElementOrHTML)) === "object"
                        ) {
                  ...
                  var inHandler = function inHandler(event) {
                    if (outTimeout !== null) {
                      ...
                      inTimeout = setTimeout(function () {
                        ...
                        : _this2.options.hoverOpenDelay) ||
                        _this2.options.openDelay);
                    }
                  };
              ...
              },
              {
                ...
                value: function _transitionEndHandler(e) {
                  ...
                  if (!hasClass(this.drop, drop.classPrefix + "-open")) {
                    removeClass(
                      this.drop,
                      drop.classPrefix + "-open-transitionend"
                    );
                  }
              ...
              },
              {
                ...
                value: function beforeCloseHandler(event) {
                  ...
                  if (
                    ...
                    this.isClosing = true;
                    shouldClose =
                      this.options.beforeClose(event, this) !== false;
                  }
      ...
      var Collapse = (function () {
        ...
        var Collapse = (function () {
          function Collapse(element, config) {
            ...
            this._triggerArray = _jquery2.default.makeArray(
              (0, _jquery2.default)(
                '[data-toggle="lu-collapse"][href="#' +
                  element.id +
                  '"],' +
                  ('[data-toggle="lu-collapse"][data-target="#' +
                    element.id +
                    '"]')
              )
            );
            ...
            for (var i = 0; i < tabToggles.length; i++) {
              ...
              if (
                selector !== null &&
                (0, _jquery2.default)(selector).filter(element).length > 0
              ) {
            ...
            [
              {
                ...
                value: function toggle() {
                  if (
                    (0, _jquery2.default)(this._element).hasClass(
                      ClassName.SHOW
                    )
                  ) {
                    this.hide();
              ...
              },
              {
                ...
                value: function show() {
                  ...
                  if (this._parent) {
                    actives = _jquery2.default.makeArray(
                      (0, _jquery2.default)(this._parent)
                        .children()
                  ...
                  (0, _jquery2.default)(this._element)
                  ...
                  if (this._triggerArray.length) {
                    (0, _jquery2.default)(this._triggerArray)
                  ...
                  var complete = function complete() {
                    (0, _jquery2.default)(_this._element)
                ...
                value: function hide() {
                  ...
                  if (this._triggerArray.length) {
                    for (var i = 0; i < this._triggerArray.length; i++) {
                      ...
                      var selector =
                        _util2.default.getSelectorFromElement(trigger);
                      if (selector !== null) {
                        var $elem = (0, _jquery2.default)(selector);
                        if (!$elem.hasClass(ClassName.SHOW)) {
                          (0, _jquery2.default)(trigger)
                  ...
                  var complete = function complete() {
                    ...
                    (0, _jquery2.default)(_this2._element)
                      .removeClass(ClassName.COLLAPSING)
                      .addClass(ClassName.COLLAPSE)
              ...
              },
              {
                ...
                value: function _getDimension() {
                  var hasWidth = (0, _jquery2.default)(this._element).hasClass(
                    Dimension.WIDTH
                  );
              ...
              },
              {
                ...
                value: function _getParent() {
                  ...
                  var selector =
                    '[data-toggle="lu-collapse"][data-parent="' +
                    this._config.parent +
                    '"]';

                  (0, _jquery2.default)(parent)
                    .find(selector)
              ...
              },
              {
                ...
                value: function _addAriaAndCollapsedClass(
                  element,
                  triggerArray
                ) {
                  if (element) {
                    var isOpen = (0, _jquery2.default)(element).hasClass(
                      ClassName.SHOW
                    );

                    if (triggerArray.length) {
                      (0, _jquery2.default)(triggerArray)
              ...
              },
              {
                ...
                value: function _jQueryInterface(config) {
                  return this.each(function () {
                    ...
                    var _config = _jquery2.default.extend(
                      {},
                      Default,
                      $this.data(),
        ...
        _createClass(contentSlider, [
          {
            ...
            value: function getConfig() {
              ...
              if (dataConfig.options) {
                this.dataOptions = _util2.default.parseDataOptions(
                  dataConfig.options
                );
              } else {
                this.dataOptions = {};
              ...
              switch (this.config.navStorage) {
                ...
                case "localStorage":
                  ...
                  window.localStorage.setItem(
                    "content-slider-" + this.config.localStorageId,
                    swiper.clickedIndex
                  );
                  break;
              }
          ...
          },
          {
            ...
            value: function slideToClickedSlide(swiper, event) {
              ...
              if (
                !$(slides[clickedIndex - 1]).hasClass("swiper-slide-visible")
              ) {
              ...
              switch (this.config.navStorage) {
                ...
                case "hash":
                  if (window.location.hash) {
                    var slide = $(swiper.container).find(
                  ...
                  break;
                case "localStorage":
                  var index = window.localStorage.getItem(
                    "content-slider-" + this.config.localStorageId
                  );
                  if (index) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var dropdown = (function () {
        function dropdown(_dropdown, options) {
          ...
          this.dropdownArrowTarget = $(this.dropdownParent).find(
            SELECTORS.dropdownArrowTarget
          );
          this.dropdownToggle = $(this.dropdownParent).find(
            SELECTORS.dropdownToggle
          );
          this.dropdownMenu = $(this.dropdownParent).find(
          ...
          },
          {
            ...
            value: function getArrowTargetPoition() {
              ...
              if (/left/i.test(this.config.placement)) {
                this.arrowTargetPosition =
                  arrowTargetOffset.left -
                  dropdownOffset.left +
                  arrowTargetWidth / 2;
              } else if (/right/i.test(this.config.placement)) {
                this.arrowTargetPosition =
                  this.dropdown.outerWidth() -
                  (arrowTargetOffset.left - dropdownOffset.left) -
                  arrowTargetWidth / 2;
              }
            },
          },
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var SELECTORS = {
        //disabled the tooltip in client area
        ...
        _createClass(tooltip, [
          ...
          },
          {
            ...
            value: function setArrowPostion() {
              ...
              $(this.drop.drop).append(
                '<div class="lu-tooltip__arrow" data-arrow></div>'
              );
              var arrow = $(this.drop.drop).find("[data-arrow]");
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var CheckAll = (function () {
        function CheckAll(container, options) {
          ...
          this.childs = this.container
            .find(SELECTORS.childs)
            .not(SELECTORS.checkAll);
                ...
                function (options) {
                  ...
                  this.positionDropdown = (function () {
                    ...
                    return function () {
                      ...
                      var controlPositon =
                        $(this.$control).offset().top - $(window).scrollTop();
                      var dropdownOffset =
                        controlHeight +
                        controlPositon +
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var alert = {
        ...
        show: function show(event) {
          ...
          if (this.$alertPosition == "top" || this.$alertPosition == "bottom") {
            ...
            if (this.$alertPosition == "top") {
              ...
              this.$alertFixedTop
                .css("margin-top", -this.$alertHeight)
                .animate({ "margin-top": 0 }, this.delay);
              ...
              this.$hideAlert = this.$alertFixedTop
                .closest(".alert")
                .find(".btn--close");
              ...
              this.$alertFixedBottom
                .css("margin-bottom", -this.$alertBottomHeight)
                .animate({ "margin-bottom": "0" }, this.delay);

              this.$hideAlert = this.$alertFixedBottom
                .closest(".alert")
                .find(".btn--close");
        ...
        getTemplate: function getTemplate() {
          ...
          if (this.$alertActions) {
            this.$actions =
              '<div class="lu-alert__actions">' + this.$alertActions + "</div>";
          }

          var $titleTemplate = "";
          if (this.$alertTitle) {
            $titleTemplate =
              '<div class="lu-alert__title">' + this.$alertTitle + " </div>";
          }

          // main alert template
          var $primaryTemplate =
            '<div class="lu-alert lu-alert--' +
            this.$alertStatus +
            ' lu-alert--outline lu-alert--float lu-alert--border-left lu-has-icon">' +
            ...
            [
              ...
              },
              {
                ...
                value: function show(relatedTarget) {
                  ...
                  if (
                    _util2.default.supportsTransitionEnd() &&
              ...
              },
              {
                ...
                value: function hide(event) {
                  ...
                  if (transition) {
                    $(this._element)
                      .one(_util2.default.TRANSITION_END, function (event) {
              ...
              },
              {
                ...
                value: function _showBackdrop(callback) {
                  ...
                  if (this._isShown && this._config.backdrop) {
                    var doAnimate =
                      _util2.default.supportsTransitionEnd() && animate;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var layersNav = {
        ...
        cacheDom: function cacheDom() {
          this.$nav = $(".lu-nav");
          this.$navigationDroDownLi = this.$nav.find(
            ".lu-nav__item.has-dropdown"
          );
        },
        bindEvents: function bindEvents() {
          var that = this;

          this.$navigationDroDownLi.on(
            "click",
            this.checkDropDownStatus.bind(this)
          );
          ...
          _enquire2.default.register(
            "screen and (min-width: 0) and (max-width: 751px)",
            {
              ...
              unmatch: function unmatch() {
                $(".has-dropdown > a").on("click", function (event) {
                  if (
                    isMobile == true ||
                    $(this).parents(".navbar--thin").length == 0
                  ) {
        ...
        checkDropDownStatus: function checkDropDownStatus(event) {
          ...
          if (toggleBack.is(event.target) || toggleBackI.is(event.target)) {
          } else {
        ...
        _createClass(Switcher, [
          ...
          },
          {
            ...
            value: function getItemPosition(element) {
              ...
              this.activeItemData.width = $(
                this.activeItemData.element
              ).outerWidth();
              this.activeItemData.position = $(
                this.activeItemData.element
              ).position().left;
            },
          },
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var Tab = (function () {
        ...
        var Selector = {
          ...
          ACTIVE_UL: "> .is-active",
          DATA_TOGGLE:
            '[data-toggle="lu-tab"], [data-toggle="pill"], [data-toggle="list"]',
            ...
            [
              {
                ...
                value: function show() {
                  ...
                  var selector = _util2.default.getSelectorFromElement(
                    this._element
                  );
                  if (listElement) {
                    var itemSelector =
          ...
          },
          {
            ...
            value: function addEventClickOutside(event) {
              if (
                ...
                !$(event.target).closest(this.element).length
              ) {
        ...
        _createClass(ScrollTo, [
          ...
          },
          {
            ...
            value: function startScroll(event) {
              this.targetPosition =
                this.target.offset().top + this.config.topOffset;
      ...
      var ScrollSpy = (function () {
        ...
        var ScrollSpy = (function () {
          function ScrollSpy(element, config) {
            ...
            (0, _jquery2.default)(this._scrollElement).on(
              Event.SCROLL,
              function (event) {
            ...
            [
              {
                ...
                value: function refresh() {
                  ...
                  var targets = _jquery2.default.makeArray(
                    (0, _jquery2.default)(this._selector)
                  );
                  ...
                  targets
                    .map(function (element) {
                      var target = void 0;
                      var targetSelector =
                        _util2.default.getSelectorFromElement(element);
                      ...
                      if (target) {
                        ...
                        if (targetBCR.width || targetBCR.height) {
                          ...
                          return [
                            (0, _jquery2.default)(target)[offsetMethod]().top +
                              offsetBase,
                            targetSelector,
                          ];
                        }
              ...
              },
              {
                ...
                value: function _activate(target) {
                  ...
                  (0, _jquery2.default)(this._scrollElement).trigger(
                    Event.ACTIVATE,
                    {
        ...
        (0, _jquery2.default)(window).on(Event.LOAD_DATA_API, function () {
          var scrollSpys = _jquery2.default.makeArray(
            (0, _jquery2.default)(Selector.DATA_SPY)
          );
        ...
        _createClass(Sticky, [
          ...
          },
          {
            ...
            value: function initPlugn() {
              this.stickyInstance = new _stickySidebar2.default(
                this.element[0],
                {
      ...
      var Toggler = (function () {
        ...
        _createClass(Toggler, [
          ...
          },
          {
            key: "getConfig",
            value: function getConfig() {
              var dataToggler = this.getTogglerOptions(
                this.element.data("toggler")
              );
          ...
          },
          {
            ...
            value: function setTargetElements() {
              ...
              if (this.targetsNames.length > 1) {
                ...
                try {
                  for (
                    var _iterator = this.targetsNames[Symbol.iterator](), _step;
                    ...
                    this.targets.push({
                      element: element,
                      options: this.getTogglerOptions(
                        element.data("toggler-options")
                      ),
                    });
                  }
                } catch (err) {
              ...
              if (this.container) {
                this.targets.push({
                  ...
                  options: this.getTogglerOptions(
                    this.container.data("toggler-options")
                  ),
                });
              }
            },
            ...
            value: function toggle() {
              for (var targetName in this.targets) {
                ...
                if (options.toggleClass)
                  element.toggleClass(options.toggleClass);
              }
            },
          },
        ]);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      (function (root, factory) {
        if (true) {
          ...
          (__WEBPACK_LOCAL_MODULE_0__ =
            typeof __WEBPACK_LOCAL_MODULE_0__factory === "function"
              ...
              : __WEBPACK_LOCAL_MODULE_0__factory),
          (__WEBPACK_LOCAL_MODULE_0__module.loaded = true),
          __WEBPACK_LOCAL_MODULE_0__ === undefined &&
            (__WEBPACK_LOCAL_MODULE_0__ =
              __WEBPACK_LOCAL_MODULE_0__module.exports));
        } else if (
          (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ===
        ...
        Sifter.prototype.prepareSearch = function (query, options) {
          if (
            (typeof query === "undefined" ? "undefined" : _typeof(query)) ===
            "object"
          )
            return query;
      ...
      (function (root, factory) {
        if (true) {
          !((__WEBPACK_LOCAL_MODULE_1__factory = factory),
          (__WEBPACK_LOCAL_MODULE_1__module = {
            id: "microplugin",
            exports: {},
            loaded: false,
          ...
          (__WEBPACK_LOCAL_MODULE_1__ =
            typeof __WEBPACK_LOCAL_MODULE_1__factory === "function"
              ...
              : __WEBPACK_LOCAL_MODULE_1__factory),
          (__WEBPACK_LOCAL_MODULE_1__module.loaded = true),
          __WEBPACK_LOCAL_MODULE_1__ === undefined &&
            (__WEBPACK_LOCAL_MODULE_1__ =
              __WEBPACK_LOCAL_MODULE_1__module.exports));
        } else if (
          (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ===
      ...
      (function (root, factory) {
         ...
         */
        var watchChildEvent = function watchChildEvent(
          $parent,
          event,
          selector,
          fn
        ...
        $.extend(Selectize.prototype, {
          ...
          setup: function setup() {
            ...
            $wrapper = $("<div>")
              ...
              .addClass(inputMode);
            $control = $("<div>")
              .addClass(settings.inputClass + " " + classes)
              .addClass("items")
              .appendTo($wrapper);
              ...
              function (require, module, exports) {
                ...
                QueryHandler.prototype = {
                  ...
                  equals: function equals(target) {
                    return (
                      this.options === target || this.options.match === target
                    );
                  },
                };
            ...
            4: [
              function (require, module, exports) {
                ...
                function isArray(target) {
                  return (
                    Object.prototype.toString.apply(target) === "[object Array]"
                  );
                }
                    ...
                    if ("up" === this.direction) {
                      ...
                      if (this.isSidebarFitsViewport()) {
                        if (
                          ...
                          dims.translateY =
                            dims.containerBottom - sidebarBottom;
