 ...
 */
class Product extends Core\Models\Whmcs\Product
{

    /**
     * 
     * @return \ModulesGarden\WordpressManager\App\Models\ProductSetting
     */
    public function setting()
    {
        return $this->hasOne('\ModulesGarden\WordpressManager\App\Models\ProductSetting', 'product_id', 'id');
    }
    ...
    public function getParams()
    {
        ...
        $statement = DB::connection()
                ...
                ->prepare("SELECT s.ipaddress AS serverip, s.hostname AS serverhostname, s.username AS serverusername, s.password AS serverpassword, s.secure AS serversecure,
                                    s.accesshash AS serveraccesshash,configoption1,configoption2,configoption3,configoption4,configoption5,configoption6,configoption7,configoption8,configoption9
