 ...
 * @property int $enable
 * @property \ModulesGarden\WordpressManager\App\Models\ThemePackageItem $items
 * @method PluginPackage enable() Description
 * @method static PluginPackage ofId(array $ids)
 */
class ThemePackage extends ExtendedEloquentModel
{
    protected $table = 'ThemePackage';
    ...
    {
        return $this->hasMany('\ModulesGarden\WordpressManager\App\Models\ThemePackageItem','theme_package_id');
    }
