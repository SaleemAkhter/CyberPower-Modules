...
class PluginPackageProvider extends BaseModelDataProvider implements AdminArea
{
    ...
    public function create()
    {
        ...
        return (new HtmlDataJsonResponse(['id' => $this->model->id]))
                        ->setMessageAndTranslate('Plugin package :name: has been added successfully')
                        ->setCallBackFunction('wpOnPluginPackageCreatedAjaxDone');
    }
    ...
    public function update()
    {
        ...
        parent::update();
        sl('lang')->addReplacementConstant('name', $this->formData['name']);
        return (new HtmlDataJsonResponse(['id' => $this->model->id]))->setMessageAndTranslate('Plugin package :name: has been updated successfully');
    }
}
