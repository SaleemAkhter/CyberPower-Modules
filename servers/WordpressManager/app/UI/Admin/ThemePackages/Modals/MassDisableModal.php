...
use ModulesGarden\WordpressManager\App\UI\Admin\ThemePackages\Forms\MassDisableForm;
 ...
 */
class MassDisableModal extends ModalConfirmDanger implements AdminArea
{
    public function initContent()
    {
        $this->initIds('massDisableModal');
        $this->addForm(new MassDisableForm());
    }
}
