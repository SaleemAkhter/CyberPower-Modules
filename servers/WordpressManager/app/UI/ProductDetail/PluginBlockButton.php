...
/**
 * Description of PluginBlockButton
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class PluginBlockButton extends ButtonDataTableModalAction  implements AdminArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-plus';

    public function initContent()
    {
        $this->initIds('pluginBlockButton');
        $this->initLoadModalAction(new PluginBlockModal());
    }
}
