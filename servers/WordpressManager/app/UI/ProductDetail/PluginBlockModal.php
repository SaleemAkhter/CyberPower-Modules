...
/**
 * Description of PluginBlockModal
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class PluginBlockModal extends ModalConfirmSuccess implements AdminArea
{
    public function initContent()
    {
        $this->initIds('pluginBlockModal');
        $this->addForm(new PluginBlockForm());
    }
}
