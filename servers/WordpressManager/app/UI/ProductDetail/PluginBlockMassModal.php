...
/**
 * Description of PluginBlockMassModal
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class PluginBlockMassModal extends ModalConfirmSuccess implements AdminArea
{

    public function initContent()
    {
        $this->initIds('PluginBlockMassModal');
        $this->addForm(new PluginBlockMassForm());
    }
}
