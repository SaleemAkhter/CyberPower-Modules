...
namespace ModulesGarden\WordpressManager\App\UI\Custom;

use \ModulesGarden\WordpressManager\Core\UI\Builder\BaseContainer;
use \ModulesGarden\WordpressManager\Core\UI\Widget\DataTable\DataProviders;
 ...
 * @author inbs
 */
class CollapsableTable extends BaseContainer implements \ModulesGarden\WordpressManager\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\WordpressManager\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\VSortable;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\TableLength;

    protected $name                = 'collapsableTable';
    protected $key                 = 'id';
    ...
    protected $defaultVueComponentName = 'mg-collapsableTable';
    ...
    public function setData(\ModulesGarden\WordpressManager\Core\UI\Interfaces\DataSetInterface $data)
    {
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\WordpressManager\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
