 ...
 */
class CacheForm extends BaseForm implements ClientArea
{
    ...
    public function initContent()
    {
        ...
        $this->initIds('cacheFlush');
        $this->setFormType('cacheFlush');
    ...
    {
        $this->setInternalAlertMessage('infoCacheFlush');
        $this->setConfirmMessage('confirmCacheFlush');
    }
}
