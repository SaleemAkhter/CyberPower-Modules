 ...
 */
class PluginActivateMassForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('pluginActivateMassForm');
        $this->setFormType('activateMass');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmPluginActivateMass', ['title' => null]);
    }
}
