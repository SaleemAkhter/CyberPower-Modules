 ...
 */
class BackupDeleteMassForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('backupDeleteMassForm');
    ...
    {
        $this->setConfirmMessage('confirmBackupDeleteMass', ['title' => null]);
    }
}
