 ...
 */
class PluginUpdateMassForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('PluginUpdateMassForm');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmPluginUpdateMass', ['title' => null]);
    }
}
