 ...
 */
class PluginDeleteMassForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('pluginDeleteMassForm');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmPluginDeleteMass', ['title' => null]);
    }
}
