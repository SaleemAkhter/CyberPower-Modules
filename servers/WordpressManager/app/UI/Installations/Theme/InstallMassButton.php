 ...
 */
class InstallMassButton extends ButtonMassAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-plus';

    public function initContent()
    {
        $this->initIds('themeInstallMassButton');
        $this->initLoadModalAction(new InstallMassModal());
    }
}
