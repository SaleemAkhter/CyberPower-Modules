 ...
 */
class DisableForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('themeDisableForm');
        $this->setFormType('disable');
    ...
    protected function initFields()
    {
        ...
        $field->setId('title');
        $this->addField($field);
        $this->setConfirmMessage('confirmThemeDisable', ['title' => $this->dataProvider->getValueById('title')]);
        $this->loadDataToForm();
    }
}
