 ...
 */
class DisableMassButton extends ButtonMassAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-close';

    public function initContent()
    {
        $this->initIds('themeDisableMassButton');
        $this->initLoadModalAction(new DisableMassModal());
    }
}
