...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\BackupDeleteModal;
 ...
 */
class BackupDeleteButton extends ButtonDataTableModalAction  implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-delete';

    public function initContent()
    {
        $this->initLoadModalAction(new BackupDeleteModal());
