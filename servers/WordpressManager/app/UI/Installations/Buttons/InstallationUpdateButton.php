 ...
 */
class InstallationUpdateButton extends ButtonMassAction implements ClientArea
{
    use \ModulesGarden\WordpressManager\Core\UI\Widget\Sidebar\SidebarTrait;
    
    protected $id   = 'installationUpdateButton';
    protected $icon = 'lu-btn__icon lu-zmdi lu-zmdi-time-restore';

    protected $htmlAttributes = [
        'data-toggle' => 'lu-tooltip',
        'title'       => 'Manage Auto Upgrade',
    ];

    public function initContent()
    {
        $this->initLoadModalAction(new InstallationUpdateModal());
        $this->setShowByColumnValue('actionsmanageautoupgrade', '1');
    }
}
