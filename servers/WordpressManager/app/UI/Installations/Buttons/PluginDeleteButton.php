...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginDeleteModal;
 ...
 */
class PluginDeleteButton extends ButtonDataTableModalAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-delete';

    public function initContent()
    {
        $this->initLoadModalAction(new PluginDeleteModal());
