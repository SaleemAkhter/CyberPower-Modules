...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginActivateModal;
 ...
 */
class PluginActivateButton extends ButtonDataTableModalAction implements ClientArea
{
    ...
    public function initContent()
    {
        ...
        $this->initLoadModalAction(new PluginActivateModal());
        $this->setDisableByColumnValue('statusRaw', 'active');
    }
}
