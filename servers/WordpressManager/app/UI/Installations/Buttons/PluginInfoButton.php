...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginInfoModal;
 ...
 */
class PluginInfoButton extends ButtonDataTableModalAction  implements ClientArea
{
    ...
    {
        $this->initIds('pluginInfoButton');
        $this->initLoadModalAction(new PluginInfoModal());
    }
}
