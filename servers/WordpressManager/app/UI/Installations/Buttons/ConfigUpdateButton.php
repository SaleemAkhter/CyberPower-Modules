...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\ConfigUpdateModal;
 ...
 */
class ConfigUpdateButton extends ButtonDatatableShowModal implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-edit';

    public function initContent()
    {
        $this->initLoadModalAction(new ConfigUpdateModal());
    }
}
