...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginUpdateMassModal;
 ...
 */
class PluginUpdateMassButton extends ButtonMassAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-upload';

    public function initContent()
    {
        $this->initIds('pluginUpdateMassButton');
        $this->initLoadModalAction(new PluginUpdateMassModal());
    }
}
