...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\ConfigDeleteModal;
 ...
 */
class ConfigDeleteButton extends ButtonDataTableModalAction implements ClientArea
{
    public function initContent()
    {
        $this->initLoadModalAction(new ConfigDeleteModal());
