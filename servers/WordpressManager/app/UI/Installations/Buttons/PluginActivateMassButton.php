...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginActivateMassModal;
 ...
 */
class PluginActivateMassButton extends ButtonMassAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-check';

    public function initContent()
    {
        $this->initIds('pluginActivateMassButton');
        $this->initLoadModalAction(new PluginActivateMassModal());
    }
}
