...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\BackupRestoreModal;
 ...
 */
class BackupRestoreButton extends ButtonDatatableShowModal implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-time-restore-setting';

    public function initContent()
    {
        $this->initLoadModalAction(new BackupRestoreModal());
    }
}
