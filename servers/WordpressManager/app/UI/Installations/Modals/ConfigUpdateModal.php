...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\ConfigUpdateForm;
 ...
 */
class ConfigUpdateModal extends BaseEditModal implements ClientArea
{

    public function initContent()
    {
        $this->initIds('configUpdateModal');
        $this->addForm(new ConfigUpdateForm());
    }
}
