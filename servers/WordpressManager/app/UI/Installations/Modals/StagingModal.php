...
use \ModulesGarden\WordpressManager\App\UI\Installations\Forms\StagingForm;
/**
 * Description of InstallationStagingModal
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class StagingModal extends BaseEditModal implements ClientArea
{

    public function initContent()
    {  
        $this->initIds('stagingModal');
        $this->initActionButtons();
        $this->addForm(new StagingForm($this));
    }
}
