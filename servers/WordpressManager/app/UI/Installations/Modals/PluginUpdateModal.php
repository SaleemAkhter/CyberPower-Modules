...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\PluginUpdateForm;
 ...
 */
class PluginUpdateModal extends ModalConfirmSuccess implements ClientArea
{

    public function initContent()
    {
        $this->initIds('pluginUpdateModal');
        $this->addForm(new PluginUpdateForm());
    }
}
