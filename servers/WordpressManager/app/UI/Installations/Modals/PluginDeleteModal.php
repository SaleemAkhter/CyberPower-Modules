...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\PluginDeleteForm;
 ...
 */
class PluginDeleteModal extends ModalConfirmDanger implements ClientArea
{

    public function initContent()
    {
        $this->initIds('pluginDeleteModal');
        $this->addForm(new PluginDeleteForm());
    }
}
