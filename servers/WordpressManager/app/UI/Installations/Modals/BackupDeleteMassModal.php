...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\BackupDeleteMassForm;
 ...
 */
class BackupDeleteMassModal extends ModalConfirmDanger implements ClientArea
{

    public function initContent()
    {
        $this->initIds('backupDeleteMassModal');
        $this->replaceSubmitButtonClasses(['lu-btn lu-btn--danger submitForm']);
        $this->addForm(new BackupDeleteMassForm());
    }
}
