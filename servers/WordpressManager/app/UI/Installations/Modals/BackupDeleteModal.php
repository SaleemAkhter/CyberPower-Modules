...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\BackupDeleteForm;
 ...
 */
class BackupDeleteModal extends ModalConfirmDanger implements ClientArea
{

    public function initContent()
    {
        $this->initIds('backupDeleteModal');
        $this->replaceSubmitButtonClasses(['lu-btn lu-btn--danger submitForm']);
        $this->addForm(new BackupDeleteForm());
    }
}
