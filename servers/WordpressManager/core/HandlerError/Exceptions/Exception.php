...
namespace ModulesGarden\WordpressManager\Core\HandlerError\Exceptions;

use ModulesGarden\WordpressManager\Core\ServiceLocator;
use ModulesGarden\WordpressManager\Core\HandlerError\ErrorManager;
...
class Exception extends \Exception
{
    ...
    use \ModulesGarden\WordpressManager\Core\Traits\IsDebugOn;
     ...
     * 
     * @var type \ModulesGarden\WordpressManager\Core\HandlerError\ErrorCodes\ErrorCode
     */
    ...
    public function setOriginalException($originalException)
    {
        if ($originalException instanceof \Exception)
        {
            ...
            parent::__construct($originalException->getMessage(),(int) $originalException->getCode(), $originalException->getPrevious());
        }
    }    
