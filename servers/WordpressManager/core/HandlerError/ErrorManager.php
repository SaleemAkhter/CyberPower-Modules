...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\WordpressManager\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\WordpressManager\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\WordpressManager\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\WordpressManager\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\WordpressManager\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\WordpressManager\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\WordpressManager\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\WordpressManager\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\WordpressManager\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\WordpressManager\Core\HandlerError\Model\Warning $warning)
    {
