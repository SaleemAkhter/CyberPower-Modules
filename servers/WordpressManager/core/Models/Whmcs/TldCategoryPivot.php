...
class TldCategoryPivot extends EloquentModel
{
    ...
    public function tld()
    {
        return $this->hasOne('ModulesGarden\WordpressManager\Core\Models\Whmcs\Tld', 'tld_id');
    }

    public function category()
    {
        return $this->hasOne('ModulesGarden\WordpressManager\Core\Models\Whmcs\TldCategory', 'tld_id');
    }
}
