...
class Product extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\WordpressManager\Core\Models\Whmcs\ProductGroup", "gid");
    }

    public function upgrades()
    {
        return $this->hasMany("ModulesGarden\WordpressManager\Core\Models\Whmcs\ProductUpgrade", "product_id");
    }
}
