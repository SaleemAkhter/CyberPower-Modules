...
namespace ModulesGarden\WordpressManager\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\WordpressManager\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\WordpressManager\Core\FileReader\|\ModulesGarden\WordpressManager\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\WordpressManager\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\WordpressManager\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\WordpressManager\Core\DependencyInjection\DependencyInjection::call($requirement);
