...
use ModulesGarden\WordpressManager\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\WordpressManager\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\WordpressManager\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\WordpressManager\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\WordpressManager\Core\Configuration\Addon\Config\After::class)->execute($return);
