...
use \ModulesGarden\WordpressManager\Core\UI\Builder\Config;
use \ModulesGarden\WordpressManager\Core\Helper;
use \ModulesGarden\WordpressManager\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\WordpressManager\Core\Helper\sl('request')->get('index');
