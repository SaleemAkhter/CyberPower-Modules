...
namespace ModulesGarden\WordpressManager\Core\UI\Widget\Forms\DataProviders;

use \ModulesGarden\WordpressManager\Core\UI\Interfaces\FormDataProviderInterface;
...
abstract class BaseDataProvider implements FormDataProviderInterface
{
    ...
    use \ModulesGarden\WordpressManager\Core\UI\Traits\RequestFormDataHandler;
