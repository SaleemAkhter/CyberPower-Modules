 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\WordpressManager\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\WordpressManager\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\WordpressManager\Core\UI\Traits\Form;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\Fields;
    use \ModulesGarden\WordpressManager\Core\UI\Traits\Sections;    
    ...
    public function returnAjaxData()
    {
        ...
        if ($response instanceof \ModulesGarden\WordpressManager\Core\UI\Interfaces\ResponseInterface)
        {
            return $response;
        }
