...
namespace ModulesGarden\WordpressManager\Core\UI\Widget\DataTable\DataProviders\Providers;

use \ModulesGarden\WordpressManager\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\WordpressManager\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\WordpressManager\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
