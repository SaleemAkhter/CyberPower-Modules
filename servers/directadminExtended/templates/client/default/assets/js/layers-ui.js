...
var SELECTORS = {
    ...
    dropdownParent: ' .lu-has-dropdown ',
...
var options={container:"#layers"};
var tooltip = function () {
    function tooltip(_tooltip, options) {
        _classCallCheck(this, tooltip);
        // options.container="#layers";
...
var layersNav = {
    ...
    cacheDom: function cacheDom() {
        this.$nav = $('.lu-nav');
        this.$navigationDroDownLi = this.$nav.find('.lu-nav__item .lu-has-dropdown ');
    },
    bindEvents: function bindEvents() {
        var that = this;
        ...
        _enquire2.default.register("screen and (min-width: 0) and (max-width: 751px)", {
            match: function match() {
                $(' .lu-has-dropdown  > a').on('click', function (event) {
        ...
        $(window).on('click', function (event) {
            ...
            $('.nav  .lu-has-dropdown ').removeClass('is-open');
        }.bind(this));
    },
    ...
    showDropDown: function showDropDown(event) {
        ...
        var dropDownContainer = $(event.currentTarget).find(' .lu-has-dropdown ');
