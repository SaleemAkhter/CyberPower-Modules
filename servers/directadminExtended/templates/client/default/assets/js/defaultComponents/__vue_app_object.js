...
var mgDefauleVueObject = {
            ...
            methods: {
                ...
                changeUnlimitedFields:function(field){
                ...
                ajaxAction : function(event, targetId, namespace, index, postData,addSpinner) {
                    console.log(targetId,event.target,"addSpinner");
                    ...
                    self.getActionId(event);
                    self.addUrlComponent('ajax', '1');
                    if(jQuery(event.target).closest(".lu-t-c__mass-actions.lu-top.is-open").length){
                        self.initMassActions(event);
                        console.log(self.massActionIds);
                ...
                changeUnlimitedSwitchField1s:function(event){
                    var self = this;
                    console.log(self);
