        ...
        <div class="box-body">
            <div class="lu-row">
                <div class=" lu-col-md-12 ">
                 <form  action="" :id="'backupschedule'" method="POST" :index="component_index" mgformtype="update" :namespace="component_namespace">
                    ...
                    <div class="lu-widget__header">
                        ...
                        <div class="lu-widget__nav swiper-container swiper-container-horizontal swiper-container-false" data-content-slider="" style="visibility: visible;">
                            <ul class="swiper-wrapper lu-nav lu-nav--md lu-nav--h lu-nav--tabs lu-nav--arrow">
                                ...
                                <li   class="lu-nav__item swiper-slide" @click="setStep(4)">
                                ...
                                <div id="contTabstep1"  class="lu-tab-pane " :class="{ 'is-active': step==1 }">
                                                            ...
                                                            <td>
                                                                <div class="lu-rail">
                                                                    <div class="lu-form-check" v-show="selectedreseller!=reseller">
                                                                        <label>
                                                                            <input type="checkbox" v-on:change="selectResellerUsers(reseller)" class="lu-form-checkbox reseller-check table-mass-action-check" v-model="children" {literal}:value="reseller"{/literal}>
                                   ...
                                   <div class="checkbox pl-20">
                                          <label style="display:inherit; padding:0px;">
                                            <input type="checkbox" value="on" id="skipsuspended" name="skipsuspended" v-model="data.skipsuspended">
                                            <span style="">{$MGLANG->T("skipsuspended")}</span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="footeractionButtons">
                    ...
                    <div class="right">
                        <div class="ui-form-submit" >
                            <a href="javascript:;" :disabled="isScheduleButtonDisabled()" @click="scheduleBackup('backupschedule',$event)" class="lu-btn lu-btn--info mg-submit-form">{$MGLANG->T("save")}</a>
                        </div>
