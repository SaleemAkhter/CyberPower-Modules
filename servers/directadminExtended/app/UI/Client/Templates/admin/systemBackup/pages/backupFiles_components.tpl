<script type="text/x-template" id="t-mg-backupFile-{$elementId|strtolower}"
        :component_id="component_id"
        :component_namespace="component_namespace"
        :component_index="component_index"
        >
    <div class=" lu-col-md-12 " id="mg-backupFile">
    <div class="box light">
                                            ...
                                            <div class=" lu-col-md-12 ">
                                                <div class="box light">
                                                    <div class="box-body">
                                                        <div class="lu-row">
                                                            <div class=" lu-col-md-12 ">
                                                                <form  action="" :id="'fileForm'" method="POST" :index="component_index" mgformtype="update" :namespace="component_namespace">
                                                                    <input type="hidden" name="selectedUsers" v-model="children"  />
                                                                    <div class="lu-form-group">
                                                                        <div class="lu-input-group">
                                                                            <input class="lu-form-control" type="text" placeholder="" name="file" value="" v-model="file" required>
                                                                            <div class="ui-form-submit" >
                                                                                <a href="javascript:;" @click="addFile('fileForm',$event)" class="lu-btn lu-btn--info mg-submit-form">{$MGLANG->T("add")}</a>
                                                                            </div>
                                                                        </div>
