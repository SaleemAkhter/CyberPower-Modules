mgJsComponentHandler.addDefaultComponent('mg-backupEdit', {
    template : '#t-mg-backupEdit',
    props: [
    'component_id',
    'component_namespace',
    'component_index'
    ...
    methods: {
        ...
        selectChangeAction:function(value,v){
            ...
            // var self=this;
            // var selectedOpt=jQuery("#SELECTED_MOUNT_POINT").val();
            // self.data.optionsactivefields.push(jQuery("#SELECTED_MOUNT_POINT").val());
        ...
        initOptionsSelect: function() {
            var self = this;
            var component_id="SELECTED_MOUNT_POINT";
            ...
            var component_id="RTRANS_METHOD";
            if ($('#' + component_id).hasClass('selectized')) {
                var selectizedInstance = $('#' + component_id).selectize();
                selectizedInstance[0].selectize.destroy();
            }
