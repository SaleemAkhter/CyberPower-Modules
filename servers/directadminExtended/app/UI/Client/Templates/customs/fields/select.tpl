...
*}
<div class="lu-row">
<div class="lu-form-group--horizontal {$rawObject->getContainerClasss()}">
    ...
    <div class="lu-input-group lu-flex-grow-1" >
    <select
    ...
    <div class="lu-form-feedback lu-form-feedback--icon" hidden="hidden">
        ...
        <button @click="submitForm('{$rawObject->getFormId()}', $event)" class="lu-input-group__btn lu-btn lu-btn--success mg-submit-form" type="button"><span class="lu-btn__text">Save</span></button>
        </div>
