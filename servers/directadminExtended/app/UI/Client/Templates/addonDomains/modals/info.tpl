...
{**
* @author Mateusz Pawłowski <mateusz.pa@modueslagrden.com>
*}
        ...
        <div class="lu-modal__content" id="mgModalContainer">
            <div class="lu-modal__top lu-top">
                ...
                <div class="lu-top__toolbar">
                    <button class="lu-btn lu-btn--xs lu-btn--icon lu-btn--link lu-btn--plain closeModal" v-on:click="closeModal($event)">
            ...
            <div class="lu-modal__body">
                <div class="lu-row">
                    <div class="lu-col-md-12">
                        {foreach from=$rawObject->getElements() item=element }
                            {$element->getHtml()}
                        {/foreach}
                    </div>
                </div>
