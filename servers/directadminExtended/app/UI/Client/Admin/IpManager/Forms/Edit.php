...
class Edit extends BaseForm implements ClientArea
{
    ...
    private function addSwitcherSection()
    {
        ...
        $this->addField((new ActionSwitcher('bandwidthUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('usageUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('inodeUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('vdomainsUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('nsubdomainsUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('nemailsUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('nemailfUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('nemailmlUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('nemailrUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('mysqlUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('domainptrUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ->addField((new ActionSwitcher('ftpUnlimited'))->addHtmlAttribute('@change', 'initReloadModal()'))
        ...
        ->addField( (new ActionSwitcher('ssl')))
