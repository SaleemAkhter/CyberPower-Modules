...
namespace ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Admin\MoveBetweenResellers\Pages;
...
class UserList extends DataTableApi implements ClientArea
{
    use WhmcsParams;

    protected $id    = 'moveuserList';
    ...
    protected function loadHtml()
    {
        if(isset($_POST['formData'])){
            ...
            if(isset($response->success)){
                echo  (new ResponseTemplates\RawDataJsonResponse([
                    'url' => $this->getMoveUsersURL(),
                    ]))->setMessageAndTranslate('userHasBeenMoved')->setCallBackFunction('redirectAfterFormSubmit');
            }else{
                echo (new ResponseTemplates\RawDataJsonResponse([
                    'url' => $this->getMoveUsersURL(),
                    ]))->setMessageAndTranslate('unableToMoveUsers')->setCallBackFunction('redirectAfterFormSubmit');
            }
            exit;
    ...
    public function initContent()
    {
        ...
        $this->addMassActionButton(new Buttons\MassAction\SuspendUnsuspend());
    }
    ...
    protected function loadData()
    {
        ...
        $result     = $this->adminApi->reseller->moveuserlist();
