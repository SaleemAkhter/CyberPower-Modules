...
class SpamFilters extends AbstractController
{
    ...
    {
        if ($this->isFeatureEnabled(FeaturesSettingsConstants::EMAIL_FILTERS) === false)
        {
            return null;
        }
        ...
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\SpamFilter\Pages\SpamFilter::class);
    }
}
