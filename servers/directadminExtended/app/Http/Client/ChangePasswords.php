...
class ChangePasswords extends AbstractController
{
    ...
    public function index()
    {
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\ChangePasswords\Pages\ChangePasswords::class);
    }
