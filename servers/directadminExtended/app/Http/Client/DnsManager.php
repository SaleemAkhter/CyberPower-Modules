...
class DnsManager extends AbstractController
{
    ...
    public function index()
    {
        ...
        return Helper\view()
            ...
            ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Admin\DnsManager\Pages\DomainsTable::class);
    }
    ...
    public function dnsRecords()
    {
        ...
        return Helper\view()
            ->addElement(new Breadcrumb($this->getClassName(), $this->getClassMethods()))
            ->addElement(new \ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Customs\Pages\Description($this->getClassName()))
            ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Admin\DnsManager\Pages\DnsRecords::class);
    }
}
