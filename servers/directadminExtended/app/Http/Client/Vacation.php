...
class Vacation extends AbstractController
{
    ...
    {
        if ($this->isFeatureEnabled(FeaturesSettingsConstants::VACATION) === false)
        {
            return null;
        }
        ...
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Vacation\Pages\Vacation::class);
    }
}
