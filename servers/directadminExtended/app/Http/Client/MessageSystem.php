...
class MessageSystem extends AbstractController
{
    ...
    public function index()
    {
        ...
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\MessageSystem\Pages\MessageSystem::class)
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\MessageSystem\Pages\ClearMessages::class);
    }
    ...
    public function ShowMessage()
    {
        ...
        return Helper\view()
            ->addElement(new Breadcrumb($this->getClassName(), $this->getClassMethods()))
            ->addElement(new \ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Customs\Pages\Description($this->getClassName()."Show"))

            ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\MessageSystem\Pages\Show::class);
    }
}
