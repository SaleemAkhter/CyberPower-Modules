...
class SiteSummary extends AbstractController
{
    ...
    {
        if ($this->isFeatureEnabled(FeaturesSettingsConstants::SITE_SUMMARY) === false)
        {
            return null;
        }
        ...
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\SiteSummary\Pages\SiteSummary::class);
    }
}
