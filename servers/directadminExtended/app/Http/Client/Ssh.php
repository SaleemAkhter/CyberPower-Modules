...
class Ssh extends AbstractController
{
    ...
    {
        if ($this->isFeatureEnabled(FeaturesSettingsConstants::SSH) === false)
        {
            return null;
        }
        ...
        return Helper\view()
            ...
            ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Ssh\Pages\Ssh::class);
    }
}
