...
class ErrorPages extends AbstractController
{
    ...
    {
        if ($this->isFeatureEnabled(FeaturesSettingsConstants::ERROR_PAGES) === false)
        {
            return null;
        }
        return Helper\view()
                        ...
                        ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\ErrorPages\Pages\ErrorPages::class);
    }
}
