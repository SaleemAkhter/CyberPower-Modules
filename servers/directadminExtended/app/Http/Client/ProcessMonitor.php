...
class ProcessMonitor extends AbstractController
{
    ...
    public function index()
    {
        return Helper\view()
            ...
            ->addElement(\ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Admin\ProcessMonitor\Pages\ProcessTable::class);
    }
