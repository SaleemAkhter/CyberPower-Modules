...
class Ssl extends AbstractModel implements ResponseLoad
{
    ...
    protected $LETSENCRYPT_RENEWAL_DAYS;
    ...
    public function getNot_After()
    {
        return $this->Not_After;
    }
    public function setNot_After($Not_After)
    {
    ...
    public function getNot_Before()
    {
        return $this->Not_Before;
    }
    public function setNot_Before($Not_Before)
    {
         $this->Not_Before=$Not_Before;
         return $this;
    }
    public function getLETSENCRYPT_RENEWAL_DAYS()
    {
        return $this->LETSENCRYPT_RENEWAL_DAYS;
    }
    public function setLETSENCRYPT_RENEWAL_DAYS($LETSENCRYPT_RENEWAL_DAYS)
    {
         $this->LETSENCRYPT_RENEWAL_DAYS=$LETSENCRYPT_RENEWAL_DAYS;
         return $this;
    }
    /**
     * @return mixed
