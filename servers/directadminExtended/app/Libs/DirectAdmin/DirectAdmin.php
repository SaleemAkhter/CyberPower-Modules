...
use ModulesGarden\Servers\DirectAdminExtended\App\Libs\DirectAdmin\Command\MessageSystem;
...
use ModulesGarden\Servers\DirectAdminExtended\App\Libs\DirectAdmin\Command\Reseller;
...
use ModulesGarden\Servers\DirectAdminExtended\App\Libs\DirectAdmin\Command\Admin\Package as AdminPackage;
...
class DirectAdmin
{
    ...
    private $resellerMode = false;
    private $runAsAdmin=false;
    ...
    private function getCommand($command)
    {
        ...
        $this->$command->setConnection($this->params, $this->userMode,$this->resellerMode,$this->runAsAdmin);
    ...
    public function setResellerMode($resellername,$runasadmin=false)
    {
        if(!empty($resellername))
        {
            $this->resellerMode = true;
