...
use \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\ErrorCodes\ErrorCodes;
...
trait ErrorCodesLibrary
{
    ...
    public function loadErrorCodes()
    {
        ...
        {
            $this->errorCodesAppHandler = new \ModulesGarden\Servers\DirectAdminExtended\App\Helpers\ErrorCodesLib();
        }        
    }
