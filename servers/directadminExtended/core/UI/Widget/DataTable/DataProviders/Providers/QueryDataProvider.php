...
namespace ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\Providers;

use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
