...
use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\Servers\DirectAdminExtended\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
