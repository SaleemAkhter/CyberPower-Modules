...
use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Interfaces\BaseValidatorInterface;
...
trait Field
{
     ...
     *
     * @param $validator \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\Forms\Validators\BaseValidator
     * return $this
     */
    ...
    public function getLabelMobileWidth()
    {
        return $this->labelMobileWidth;
    }
    public function setLabelMobileWidth($width)
    {
        if ((int) $width > 0)
        {
            $this->labelMobileWidth = "lu-col-xs-".(int) $width;
        }
    ...
    public function setMobileWidth($width)
    {
        if ((int) $width > 0)
        {
            $this->mobileWidth = "lu-col-xs-".(int) $width;
        }
    ...
    {
        $this->addValidator(new FieldsValidators\Date());

        return $this;
    }

    public function assureRepeatedPassword()
    {
        $this->addValidator(new FieldsValidators\RepeatedPassword());

        return $this;
    }

    public function validEmailUsername()
    {
        $this->addValidator(new FieldsValidators\EmailUsername());
