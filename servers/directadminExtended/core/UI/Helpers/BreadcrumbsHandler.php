...
namespace ModulesGarden\Servers\DirectAdminExtended\Core\UI\Helpers;
...
class BreadcrumbsHandler
{
    ...
    {
        $this->breadcrumbs[] = new \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Helpers\Breadcrumb(
    ...
    public function loadDefault()
    {
        ...
        $router = new \ModulesGarden\Servers\DirectAdminExtended\Core\App\Controllers\Router();
        if ($this->isAdmin())
        {
