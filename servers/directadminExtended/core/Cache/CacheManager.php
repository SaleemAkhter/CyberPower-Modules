...
namespace ModulesGarden\Servers\DirectAdminExtended\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\DirectAdminExtended\Core\ModuleConstants;
use ModulesGarden\Servers\DirectAdminExtended\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
     ...
     * @param string $key
     * @return $this
     * @throws \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Exceptions\MGModuleException
     */
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
