...
namespace ModulesGarden\Servers\DirectAdminExtended\Core\Queue\Services;


use ModulesGarden\Servers\DirectAdminExtended\Core\Queue\Models\JobLog;
...
class Log
{
    ...
    public function __construct(\ModulesGarden\Servers\DirectAdminExtended\Core\Queue\Models\Job $job)
    {
        $this->job  = $job;
    }
