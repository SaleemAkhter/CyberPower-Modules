...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\Servers\DirectAdminExtended\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\Servers\DirectAdminExtended\Core\HandlerError\Model\Warning $warning)
    {
