...
class ApplicationDefaultInstallModel
{

    public function getWithParams(array $params, $installerName)
    {
    ...
    private function getSoftaculousModel($params, &$installationModel)
    {
        $installationModel->addField((new Field())->setName('admin_username')->setValue($params['customfields']['Admin Username'] ? $params['customfields']['Admin Username'] : $params['username']))
                ...
                ->addField((new Field())->setName('admin_pass')->setValue($params['customfields']['Admin Password'] ? $params['customfields']['Admin Password'] : $params['password']))
    ...
    {
        $installationModel->setApplication(strtolower($params['appName']))
                ->addField((new Field())->setName('login')->setValue($params['customfields']['Admin Username'] ? $params['customfields']['Admin Username'] : $params['username']))
                ->addField((new Field())->setName('passwd')->setValue($params['customfields']['Admin Password'] ? $params['customfields']['Admin Password'] : $params['password']))
        ...
        if (!empty($params['customfields']['Database Name']) 
                && !empty($params['customfields']['Database Password']) 
                && !empty($params['customfields']['Database Username']))
        {
        ...
        $installationModel->setProtocol($proto);
