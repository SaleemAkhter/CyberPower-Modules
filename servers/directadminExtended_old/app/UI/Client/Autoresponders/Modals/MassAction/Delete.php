...
namespace ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\Autoresponders\Modals\MassAction;
...
class Delete extends BaseModal implements ClientArea
{
    ...
    {
        $this->addForm(new Forms\MassAction\Delete())->setSubmitButtonClassesDanger()->setModalTitleTypeDanger();
