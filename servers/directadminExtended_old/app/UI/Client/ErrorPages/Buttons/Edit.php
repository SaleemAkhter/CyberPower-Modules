...
use ModulesGarden\Servers\DirectAdminExtended\App\UI\Client\ErrorPages\Modals;
...
class Edit extends ButtonDataTableModalAction implements ClientArea
{
    ...
    {
        $this->htmlAttributes['@click'] = 'loadModal($event, \'' . $this->id . '\', \'' . $this->getNamespace() . '\', [dataRow.id,dataRow.extension], null, true)';
    }
