...
class AdminBackupsTable extends RawDataTableApi implements ClientArea
{
    use WhmcsParams;
    protected $id    = 'adminBackupsTable';
    protected $name  = 'adminBackupsTable';
    protected $title = 'adminBackupsTableTab';
    ...
    protected  function getButtonRedirect(){
        ...
        $button->setIcon('lu-icon-in-button lu-zmdi lu-zmdi-eye')
            ...
            ->setRedirectParams(['adminbackup' => ':id']);
        return $button;
    }
