...
use ModulesGarden\Servers\DirectAdminExtended\Core\App\Controllers\Instances\Http\Integration;
...
class HookIntegratorView
{
    ...
    /**
     * @var null|string|\ModulesGarden\Servers\DirectAdminExtended\Core\UI\View
     * integration data
     */
    protected $view = null;
    ...
    {
        if ($this->view instanceof \ModulesGarden\Servers\DirectAdminExtended\Core\UI\View)
        {
