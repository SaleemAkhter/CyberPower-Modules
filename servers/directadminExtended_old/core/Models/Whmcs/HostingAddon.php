...
class HostingAddon extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\DirectAdminExtended\Core\Models\Whmcs\Addon", "addonid");
    }

    public function hosting()
    {
        return $this->belongsTo("ModulesGarden\Servers\DirectAdminExtended\Core\Models\Whmcs\Hosting", "hostingid");
    }
