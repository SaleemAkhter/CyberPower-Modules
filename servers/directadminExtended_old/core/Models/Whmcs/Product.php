...
class Product extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\DirectAdminExtended\Core\Models\Whmcs\ProductGroup", "gid");
    }

    public function upgrades()
    {
        return $this->hasMany("ModulesGarden\Servers\DirectAdminExtended\Core\Models\Whmcs\ProductUpgrade", "product_id");
    }
}
