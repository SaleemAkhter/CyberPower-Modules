...
use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Builder\Config;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\Servers\DirectAdminExtended\Core\Helper\sl('request')->get('index');
    ...
    public function addAjaxElement(\ModulesGarden\Servers\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
