...
trait Searchable
{
    ...
    public function insertSearchForm()
    {
        if ($this->searchable)
        {
            $searchForm = new \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Searchable();
    ...
    public function insertHiddenSearchForm()
    {
        if ($this->searchable)
        {
            $searchForm = new \ModulesGarden\Servers\DirectAdminExtended\Core\UI\HiddenSearchable();
