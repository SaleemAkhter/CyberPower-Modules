...
use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\DataProvider;
...
class Column
{
    ...
    public function setFilter(\ModulesGarden\Servers\DirectAdminExtended\Core\UI\Widget\DataTable\Filters $filter)
    {
        $this->filter = $filter;
