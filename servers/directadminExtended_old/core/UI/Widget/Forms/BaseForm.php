 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Traits\Form;
    use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Traits\Fields;
    use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Traits\Sections;    
    use \ModulesGarden\Servers\DirectAdminExtended\Core\UI\Traits\FormDataProvider;
