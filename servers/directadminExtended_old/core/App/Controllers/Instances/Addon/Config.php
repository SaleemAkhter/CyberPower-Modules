...
use ModulesGarden\Servers\DirectAdminExtended\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\Servers\DirectAdminExtended\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\Servers\DirectAdminExtended\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\Servers\DirectAdminExtended\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\Servers\DirectAdminExtended\Core\Configuration\Addon\Config\After::class)->execute($return);
