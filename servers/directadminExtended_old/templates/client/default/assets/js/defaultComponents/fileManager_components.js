mgJsComponentHandler.addDefaultComponent('mg-file-manager', {
    template : '#t-mg-file-manager',
    props: [
        'component_id',
        'component_namespace',
        'component_index'
        ...
        updateProjects: function(){
            ...
            resp.done(function(data){
                if (data.data.status === 'error') {
                    ...
                    if (actionData.additionalData !== undefined) {
                        self.additionalData = actionData.additionalData;
                    }
