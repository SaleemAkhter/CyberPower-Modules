...
var mgDefauleVueObject = {
            ...
            methods: {
                ...
                updateValuesAfterResourceType : function($event) {
                    console.log("aljksjdhkjashdkjhaskjhd_updateValuesAfterResourceType");
                    mgEventHandler.runCallback('SelectFieldValueChanged', $event.target.name, {data: $event.target});
                },
                ...
                submitForm : function(targetId, event) {
                    console.log("ghadiygqig89723g8rg823gr8g8g")
