{**********************************************************************
* AwsEc2 product developed. (2017-10-30)
* *
*
...
<div class="lu-form-group" {if $rawObject->isHideByColumnValue()}{literal}v-show="dataRow.{/literal}{$rawObject->getHideColumnName()}{literal} != {/literal} '{$rawObject->getHideByColumnValue()}'"{/if}>
    ...
    {if $rawObject->getHelpText()}
        <div class="help-text">{$MGLANG->T($rawObject->getHelpText())}</div>
    {/if}
