...
class Ticket extends EloquentModel
{
    ...
    {
        return $this->belongsTo('ModulesGarden\Servers\AwsEc2\Core\Models\ResellerClient', 'userid', "client_id");
    }

    public function replies()
    {
        return $this->hasMany('ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\TicketReply', 'tid');
    }

    public function department()
    {
        return $this->belongsTo("ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\TicketDepartment", "did");
    }
