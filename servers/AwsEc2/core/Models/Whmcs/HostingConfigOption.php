...
class HostingConfigOption extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\ProductConfigOption", "configid");
    }

    public function subOption()
    {
        return $this->belongsTo("ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\ProductConfigOption", "optionid");
    }
}
