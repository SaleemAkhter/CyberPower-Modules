...
class Product extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\ProductGroup", "gid");
    }

    public function upgrades()
    {
        return $this->hasMany("ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\ProductUpgrade", "product_id");
    }
}
