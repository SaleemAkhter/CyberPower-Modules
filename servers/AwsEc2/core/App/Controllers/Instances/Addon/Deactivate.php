 ...
 */
class Deactivate extends \ModulesGarden\Servers\AwsEc2\Core\App\Controllers\Instances\AddonController implements AddonController
{
    ...
    public function execute($params = [])
    {
        ...
        {
            // before
            $return = ServiceLocator::call(\ModulesGarden\Servers\AwsEc2\Core\Configuration\Addon\Deactivate\Before::class)->execute($params);
            ...
            // after
            $return = ServiceLocator::call(\ModulesGarden\Servers\AwsEc2\Core\Configuration\Addon\Deactivate\After::class)->execute($return);
