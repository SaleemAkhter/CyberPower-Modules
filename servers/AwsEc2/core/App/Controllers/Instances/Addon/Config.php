...
use ModulesGarden\Servers\AwsEc2\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\Servers\AwsEc2\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\Servers\AwsEc2\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\Servers\AwsEc2\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\Servers\AwsEc2\Core\Configuration\Addon\Config\After::class)->execute($return);
