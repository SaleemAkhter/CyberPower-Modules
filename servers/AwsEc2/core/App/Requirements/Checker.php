...
namespace ModulesGarden\Servers\AwsEc2\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\Servers\AwsEc2\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\Servers\AwsEc2\Core\FileReader\|\ModulesGarden\Servers\AwsEc2\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\Servers\AwsEc2\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\Servers\AwsEc2\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\Servers\AwsEc2\Core\DependencyInjection\DependencyInjection::call($requirement);
