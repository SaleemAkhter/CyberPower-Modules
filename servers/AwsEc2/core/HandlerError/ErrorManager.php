...
namespace ModulesGarden\Servers\AwsEc2\Core\HandlerError;
...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\Servers\AwsEc2\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\Servers\AwsEc2\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\Servers\AwsEc2\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\Servers\AwsEc2\Core\HandlerError\Model\Warning $warning)
    {
