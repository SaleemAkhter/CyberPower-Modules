...
use \ModulesGarden\Servers\AwsEc2\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Logger
     */
