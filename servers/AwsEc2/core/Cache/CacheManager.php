...
namespace ModulesGarden\Servers\AwsEc2\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\AwsEc2\Core\ModuleConstants;
use ModulesGarden\Servers\AwsEc2\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
    ...
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\AwsEc2\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
