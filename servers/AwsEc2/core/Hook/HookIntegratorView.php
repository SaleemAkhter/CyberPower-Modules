...
use ModulesGarden\Servers\AwsEc2\Core\App\Controllers\Instances\Http\Integration;
...
class HookIntegratorView
{
    ...
    /**
     * @var null|string|\ModulesGarden\Servers\AwsEc2\Core\UI\View
     * integration data
     */
    protected $view = null;
    ...
    {
        if ($this->view instanceof \ModulesGarden\Servers\AwsEc2\Core\UI\View)
        {
