...
use \ModulesGarden\Servers\AwsEc2\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\Servers\AwsEc2\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\Servers\AwsEc2\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
