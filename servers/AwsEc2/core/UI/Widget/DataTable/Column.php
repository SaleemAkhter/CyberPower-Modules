...
use \ModulesGarden\Servers\AwsEc2\Core\UI\Widget\DataTable\DataProviders\DataProvider;
...
class Column
{
    ...
    public function setFilter(\ModulesGarden\Servers\AwsEc2\Core\UI\Widget\DataTable\Filters $filter)
    {
        $this->filter = $filter;
