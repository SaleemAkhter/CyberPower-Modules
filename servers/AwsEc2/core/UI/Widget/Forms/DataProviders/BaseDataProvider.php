...
namespace ModulesGarden\Servers\AwsEc2\Core\UI\Widget\Forms\DataProviders;

use \ModulesGarden\Servers\AwsEc2\Core\UI\Interfaces\FormDataProviderInterface;
...
abstract class BaseDataProvider implements FormDataProviderInterface
{
    ...
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\RequestFormDataHandler;
    ...
    {
        if ((is_array($this->availableValues[$id]) || $this->availableValues instanceof \Countable) && count($this->availableValues[$id]) > 0)
        {
