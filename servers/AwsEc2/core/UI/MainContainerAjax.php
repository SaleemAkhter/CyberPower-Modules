...
use \ModulesGarden\Servers\AwsEc2\Core\UI\Builder\Config;
use \ModulesGarden\Servers\AwsEc2\Core\Helper;
use \ModulesGarden\Servers\AwsEc2\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\Servers\AwsEc2\Core\Helper\sl('request')->get('index');
    ...
    public function addElement($element)
    {
        ...
        if (!isset($this->ajaxElements[$id]))
        {
            ...
            if ($element instanceof \ModulesGarden\Servers\AwsEc2\Core\UI\Interfaces\AjaxElementInterface)
            {
    ...
    public function addAjaxElement(&$element)
    {
        /**
         * @var Context $element
         */
