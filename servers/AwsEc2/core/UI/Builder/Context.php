...
use ModulesGarden\Servers\AwsEc2\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Title;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Template;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Searchable;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Buttons;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Icon;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\VueComponent;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\ACL;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\Alerts;    
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\WidgetView;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\Servers\AwsEc2\Core\UI\Traits\ContainerElements;
    ...
    /**
     * @param \ModulesGarden\Servers\AwsEc2\Core\UI\Builder\Context $object
     * @return string
     */
