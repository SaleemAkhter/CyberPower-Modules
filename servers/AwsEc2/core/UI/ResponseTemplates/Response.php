...
abstract class Response
{
    ...
    protected $preventCloseModal = false;
    ...
    public function getData()
    {
        $return = [
            ...
            'preventCloseModal' => $this->preventCloseModal
        ];
    ...
    public function setMessageAndTranslate($message)
    {
        ...
        $this->message = $this->lang->absoluteTranslate('ajaxResponses', $message);
           
        return $this;
    }

    public function setPreventCloseModal()
    {
