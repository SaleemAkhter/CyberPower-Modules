...
use ModulesGarden\Servers\AwsEc2\Core\Models\Whmcs\Currency;
...
use ModulesGarden\Servers\AwsEc2\Packages\WhmcsService\Traits\CustomFieldsConfig;
...
class Product
{
    ...
    {
        if(!class_exists('\ModulesGarden\Servers\AwsEc2\App\Config\Packages\WhmcsService'))
        {
            return null;
        }

        $service = new \ModulesGarden\Servers\AwsEc2\App\Config\Packages\WhmcsService();
