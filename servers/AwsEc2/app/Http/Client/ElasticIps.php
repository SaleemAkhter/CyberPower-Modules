...
class ElasticIps extends AbstractController
{
    use WhmcsParams,
    ...
    public function index()
    {
        ...
        return Helper\view()
                ...
                ->addElement(\ModulesGarden\Servers\AwsEc2\App\UI\Client\ElasticIps\Pages\ElasticIpsPage::class);
    ...
    public function associate()
    {
        ...
        if (!($this->getWhmcsParamByKey('status') === 'Active'))
            ...
            return Helper\view()
                ->addElement(new Breadcrumb($this->getClassName(), $this->getClassMethods()))
                // ->addElement(ModuleDescription::class)
                ->addElement(\ModulesGarden\Servers\AwsEc2\App\UI\Client\ElasticIps\Forms\AssociateIpForm::class);
    ...
    public function disassociate()
    {
        ...
        if (!($this->getWhmcsParamByKey('status') === 'Active'))
            ...
            return Helper\view()
                // ->addElement(ModuleDescription::class)
                ->addElement(\ModulesGarden\Servers\AwsEc2\App\UI\Client\ElasticIps\Forms\DisassociateIpForm::class);
