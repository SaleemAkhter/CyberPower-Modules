...
use ModulesGarden\Servers\AwsEc2\App\UI\Client\ElasticIps\Providers\ElasticIpsReleaseProvider;
...
class ReleaseForm extends BaseForm implements ClientArea
{
    ...
    public function initContent()
    {
        $this->setFormType(FormConstants::DELETE)
            ->setProvider(new ElasticIpsReleaseProvider());
