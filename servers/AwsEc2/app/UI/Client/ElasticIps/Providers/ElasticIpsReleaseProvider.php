...
class ElasticIpsReleaseProvider extends BaseDataProvider
{
    ...
    public function delete()
    {
        ...
        try
        {
            $allocationId=$this->formData['allocationId'];
            $disassociated        = $apiConnection->releaseAddress(['AllocationId'=>$allocationId]);
        }
