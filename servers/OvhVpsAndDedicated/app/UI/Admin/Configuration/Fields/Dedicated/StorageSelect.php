 ...
 * @property  Api $api
 */
class StorageSelect extends DedicatedConfigSelect implements AdminArea
{


    public function initContent()
    {
        $this->initIds("packageconfigoption_storage");
    }
    ...
    public function prepareAjaxData()
    {
        ...
        //set selected value
        $this->setValue( $this->fieldsProvider->getField('storage'));
    }
