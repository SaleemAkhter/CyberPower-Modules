 ...
 * @property  Api $api
 */
class DistributionLicenseSelect extends DedicatedConfigSelect implements AdminArea
{


    public function initContent()
    {
        $this->initIds("packageconfigoption_distributionLicense");
    }
    ...
    public function prepareAjaxData()
    {
        ...
        foreach ($response as $plan){
            if($plan['family']!="distribution-license"){
                continue;
            }
        ...
        //set selected value
        $this->setValue( $this->fieldsProvider->getField('distributionLicense'));
    }
