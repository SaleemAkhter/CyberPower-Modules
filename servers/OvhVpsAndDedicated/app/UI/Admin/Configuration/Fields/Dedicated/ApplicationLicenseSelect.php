 ...
 * @property  Api $api
 */
class ApplicationLicenseSelect extends DedicatedConfigSelect implements AdminArea
{


    public function initContent()
    {
        $this->initIds("packageconfigoption_applicationLicense");
        $this->name = 'packageconfigoption_applicationLicense[]';
        $this->enableMultiple();
    }
    ...
    public function prepareAjaxData()
    {
        ...
        foreach ($response as $plan){
            if($plan['family']!="application-license"){
                continue;
            }
        ...
        //set selected value
        $this->setValue( \json_decode($this->fieldsProvider->getField('applicationLicense'), true));
    }
