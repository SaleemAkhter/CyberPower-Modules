 ...
 * @property  Api $api
 */
class BandwidtSelect extends DedicatedConfigSelect implements AdminArea
{


    public function initContent()
    {
        $this->initIds("packageconfigoption_bandwidth");
    }
    ...
    public function prepareAjaxData()
    {
        ...
        //set selected value
        $this->setValue( $this->fieldsProvider->getField('bandwidth'));
    }
