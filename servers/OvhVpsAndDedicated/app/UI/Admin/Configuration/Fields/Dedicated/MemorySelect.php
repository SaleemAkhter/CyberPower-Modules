 ...
 * @property  Api $api
 */
class MemorySelect extends DedicatedConfigSelect implements AdminArea
{


    public function initContent()
    {
        $this->initIds("packageconfigoption_memory");
    }
    ...
    public function prepareAjaxData()
    {
        ...
        //set selected value
        $this->setValue( $this->fieldsProvider->getField('memory'));
    }
