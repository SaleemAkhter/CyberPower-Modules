...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\App\UI\Admin\Configuration\Providers\Dedicated;
 ...
 */
class ConfigurableDedicatedOptionManage extends BaseDataProvider implements AdminArea
{
    ...
    public function read()
    {
        ...
        ConfigurableOptionsBuilder::buildAllDedicated($configurableOption);
    ...
    public function create()
    {
        try
        {
            ...
            ConfigurableOptionsBuilder::buildDedicated($configurableOption, $this->formData);
