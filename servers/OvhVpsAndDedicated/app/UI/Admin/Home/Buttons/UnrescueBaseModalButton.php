...
use ModulesGarden\Servers\OvhVpsAndDedicated\App\UI\Admin\Home\Modals\UnrescueConfirm;
use const DS;
 ...
 */
class UnrescueBaseModalButton extends BaseControlButton implements ClientArea, AdminArea
{

    protected $id               = 'unrescueButton'; // atrybut id w tag-u
    protected $name             = 'rebuild'; // atrybut name w tagu
    protected $icon             = 'lu-zmdi lu-zmdi-refresh';
    protected $title            = 'unrescueButton';


    public function initContent()
    {
        $this->initLoadModalAction(new UnrescueConfirm());
    }
