 ...
 */
class Diskss extends BaseControlButton implements AdminArea, ClientArea
{
    use WhmcsParamsApp;

    protected $id               = 'disksManagementButton';
    protected $name             = 'disksManagementButton';
    protected $icon             = 'disks';
    protected $title            = 'disksManagementButton';
    protected $htmlAttributes = [
        'data-toggle' => 'lu-tooltip',
    ];

    protected $page = 'disks';
