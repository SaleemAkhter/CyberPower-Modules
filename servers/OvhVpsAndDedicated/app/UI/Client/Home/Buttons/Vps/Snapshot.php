 ...
 */
class Snapshot extends BaseControlButton implements AdminArea, ClientArea
{
    use WhmcsParamsApp;

    protected $id               = 'snapshotManagementButton';
    protected $name             = 'snapshotManagementButton';
    protected $icon             = 'snapshots';
    protected $title            = 'snapshotManagementButton';
    protected $htmlAttributes = [
        'data-toggle' => 'lu-tooltip',
    ];

    protected $page = 'snapshots';
