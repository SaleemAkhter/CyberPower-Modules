...
use ModulesGarden\Servers\OvhVpsAndDedicated\App\Models\Whmcs\ProductConfigGroups;
use ModulesGarden\Servers\OvhVpsAndDedicated\App\Models\Whmcs\ProductConfigLinks;
...
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\Currency;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\Pricing;
...
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\ProductConfigOptionSub;
...
abstract class AbstractConfigurableOptions
{
     ...
     * Get Product 
     * 
     * @return object \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\Product
     * 
     */
    ...
    {
        $check = \ModulesGarden\Servers\OvhVpsAndDedicated\App\Models\Whmcs\ProductConfigLinks::where('pid', $this->productID)->first();
        if (!is_null($check))
        {
     ...
     * @params object \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\ProductConfigOptionsSub $sobOptions
     * @throw \Exception
     */
     ...
     * 
     * $params object \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\Product $product
     * @throw \Exception
     */
    ...
    private function createOptionsGroup()
    {
        ...
        $optionsGroup->description = "Auto generated by module OVH VPS & Dedicated Servers"; //TODO pobrać z nazwy addonu
        $optionsGroup->save();
     ...
     * 
     * $params object \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\ProductConfigGroups $optionsGroup
     * @throw \Exception
     */
     ...
     * @params object \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs\ProductConfigOptionsSub $sobOption
     * @throw \Exception
     */
