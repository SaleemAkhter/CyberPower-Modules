...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Builder;

use ModulesGarden\Servers\OvhVpsAndDedicated\Core\ServiceLocator;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Title;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Template;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Searchable;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Buttons;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Icon;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\VueComponent;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\ACL;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Alerts;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\WidgetView;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\ContainerElements;
    ...
    /**
     * @param \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Builder\Context $object
     * @return string
     */
