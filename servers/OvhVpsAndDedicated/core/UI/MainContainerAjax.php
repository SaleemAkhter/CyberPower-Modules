...
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Builder\Config;
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper;
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\sl('request')->get('index');
    ...
    public function addAjaxElement(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
