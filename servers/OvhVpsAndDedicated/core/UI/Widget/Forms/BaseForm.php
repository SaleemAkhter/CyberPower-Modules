 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\Form;
    ...
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Traits\FormDataProvider;
    ...
    public function returnAjaxData()
    {
        ...
        if ($response instanceof \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\Interfaces\ResponseInterface)
        {
            return $response;
        }
