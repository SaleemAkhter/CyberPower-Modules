...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\Servers\OvhVpsAndDedicated\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\Servers\OvhVpsAndDedicated\Core\FileReader\|\ModulesGarden\Servers\OvhVpsAndDedicated\Core\FileReader\Directory
     */
     ...
     */
    const PATHS = [
        'app' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Requirements',
        'core' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Requirements'
    ];
 
    public function __construct()
    {
        $this->directoryHandler = new \ModulesGarden\Servers\OvhVpsAndDedicated\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\Servers\OvhVpsAndDedicated\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\Servers\OvhVpsAndDedicated\Core\DependencyInjection\DependencyInjection::call($requirement);
