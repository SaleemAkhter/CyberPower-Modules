...
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\View;
...
class ResponseResolver
{
    ...
    use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Traits\Template;
    ...
    {
        /**
         * @var $this->response \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\View
         */
    ...
    /**
     * resolve \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\JsonResponse
     */
    public function resolveJson()
    {
        $this->cleanOutputBuffer();
        /**
         * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\JsonResponse
         */
        $this->response->send();
        die();
    }
    ...
    {
        /**
         * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\RedirectResponse
         */
