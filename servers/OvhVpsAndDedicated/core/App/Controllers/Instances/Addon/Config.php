...
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\Servers\OvhVpsAndDedicated\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Configuration\Addon\Config\After::class)->execute($return);
