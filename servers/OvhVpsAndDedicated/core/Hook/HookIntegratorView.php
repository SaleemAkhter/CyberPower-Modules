...
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\App\Controllers\Instances\Http\Integration;
...
class HookIntegratorView
{
    ...
    /**
     * @var null|string|\ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\View
     * integration data
     */
    protected $view = null;
    ...
    {
        if ($this->view instanceof \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\View)
        {
