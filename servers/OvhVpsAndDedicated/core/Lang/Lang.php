...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\Lang;

use ModulesGarden\Servers\OvhVpsAndDedicated\Core\ModuleConstants;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Models\Whmcs as wModels;;
...
class Lang
{
    ...
    public function loadLang($lang)
    {
        ...
        {
            include $file;
            $this->langs       = array_merge((array) $this->langs,(array) $_LANG);
