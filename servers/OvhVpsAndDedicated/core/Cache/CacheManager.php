<?php
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\ModuleConstants;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
     ...
     * @param string $key
     * @return $this
     * @throws \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Exceptions\MGModuleException
     */
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
