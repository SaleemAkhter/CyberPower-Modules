...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\Queue\Services;


use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Queue\Models\JobLog;
...
class Log
{
    ...
    public function __construct(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Queue\Models\Job $job)
    {
        $this->job  = $job;
    }
