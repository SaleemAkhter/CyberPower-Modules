...
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\ErrorCodes\ErrorCodes;
...
trait ErrorCodesLibrary
{
    ...
    public function loadErrorCodes()
    {
        ...
        {
            $this->errorCodesAppHandler = new \ModulesGarden\Servers\OvhVpsAndDedicated\App\Helpers\ErrorCodesLib();
        }        
    }
