...
namespace ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper;

use ModulesGarden\Servers\OvhVpsAndDedicated\App\Libs\Api\ApiClient;
use ModulesGarden\Servers\OvhVpsAndDedicated\App\Libs\Api\Ovh;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Events\Dispatcher;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\JsonResponse;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\RedirectResponse;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\Response;
...
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Cache\CacheManager;
use ModulesGarden\Servers\OvhVpsAndDedicated\Core\Logger\Entity;

if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\json'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\response'))
{

    /**
     * @param array $data
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\Response
     */
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\cache'))
{

    /**
     * @param array $data
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Interfaces\CacheManagerInterface
     */
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\redirect'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\redirectByUrl'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\t'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\errorLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\successLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\infoLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\criticalLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\debugLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\sl'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\di'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\isAdmin'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\getAdminDirName'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\getModuleName'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\view'))
{

    /**
     * main View Controler
     * 
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\View
     */
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\viewIntegrationAddon'))
{

    /**
     * View Integratio nAddon Controler
     * 
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\UI\ViewIntegrationAddon
     */
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\convertStringToNamespace'))
{
...
if (!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\getRequest'))
{
    function getRequest()
    {
        return sl(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Http\Request::class);
    }
}

if(!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\fire'))
{
    /**
     * Fire event!
     * @param $event
...
if(!function_exists('\ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\queue'))
{
