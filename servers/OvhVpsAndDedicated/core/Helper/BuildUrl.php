...
use function \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Helper\getModuleName;
...
class BuildUrl
{
    ...
    {
        $modulePath = \ModulesGarden\Servers\OvhVpsAndDedicated\Core\ModuleConstants::getFullPath();
