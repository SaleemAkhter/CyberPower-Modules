...
use \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Logger
     */
