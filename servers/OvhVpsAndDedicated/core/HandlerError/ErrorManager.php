...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\Servers\OvhVpsAndDedicated\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\Servers\OvhVpsAndDedicated\Core\HandlerError\Model\Warning $warning)
    {
