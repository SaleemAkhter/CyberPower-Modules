...
<div class="cf_d_mangr">
    ...
    <div class="panel panel-default text-left">
        ...
        <div class="panel-body">
            <table class="table" id="domain_list">
                <thead>
                    <tr>
                    ...
                    {foreach from=$zones item=zone key=num}
                        <tr>
                            ...
                            <td>
                                ...
                                {if !$zone.default} &nbsp; <button class='btn manage-btn delete' onclick="deleteDomain(this, '{$zone.zonename}', '{$wgs_lang.cf_domains_domain_warning}');" title="{$wgs_lang.cf_domains_delete}"></button>{/if}
