        ...
        if (count($addonModule) > 0) {
            ...
            $configarray = array(
                ...
                "enable_icon" => array(
                    ...
                    "Type" => "yesno",
                    "Size" => "10",
                    "Description" => "<a style='text-decoration:none;' href='javacsript::' title='Enable icons for the clientarea while order a product.'><img src='../modules/servers/vmware/images/info.gif'></a>{$aclHtml}",
