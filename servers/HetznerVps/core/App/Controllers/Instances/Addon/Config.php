...
use ModulesGarden\Servers\HetznerVps\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\Servers\HetznerVps\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\Servers\HetznerVps\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\Servers\HetznerVps\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\Servers\HetznerVps\Core\Configuration\Addon\Config\After::class)->execute($return);
