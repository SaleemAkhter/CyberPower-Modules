...
namespace ModulesGarden\Servers\HetznerVps\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\Servers\HetznerVps\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\Servers\HetznerVps\Core\FileReader\|\ModulesGarden\Servers\HetznerVps\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\Servers\HetznerVps\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\Servers\HetznerVps\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\Servers\HetznerVps\Core\DependencyInjection\DependencyInjection::call($requirement);
