...
use ModulesGarden\Servers\HetznerVps\Core\FileReader\Directory;
...
class PackageManager
{
    ...
    public function getPackageListByDirectory()
    {
        ...
        {
            $className = '\ModulesGarden\Servers\HetznerVps\Packages\\' . $packageName . '\Config\PackageConfiguration';
