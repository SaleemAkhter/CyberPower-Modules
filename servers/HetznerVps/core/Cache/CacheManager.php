...
namespace ModulesGarden\Servers\HetznerVps\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\Servers\HetznerVps\Core\ModuleConstants;
use ModulesGarden\Servers\HetznerVps\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
    ...
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
