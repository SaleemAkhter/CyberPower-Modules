...
use \ModulesGarden\Servers\HetznerVps\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Logger
     */
