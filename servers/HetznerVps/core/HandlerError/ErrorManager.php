...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\Servers\HetznerVps\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\Servers\HetznerVps\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\Servers\HetznerVps\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\Servers\HetznerVps\Core\HandlerError\Model\Warning $warning)
    {
