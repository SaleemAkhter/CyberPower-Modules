...
class ProductUpgrade extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\Servers\HetznerVps\Core\Models\Whmcs\Product", "product_id");
    }

    public function newproduct()
    {
        return $this->belongsTo("ModulesGarden\Servers\HetznerVps\Core\Models\Whmcs\Product", "upgrade_product_id");
    }
}
