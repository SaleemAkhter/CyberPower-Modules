...
namespace ModulesGarden\Servers\HetznerVps\Core\UI\Widget\Forms\DataProviders;
...
abstract class BaseDataProvider implements FormDataProviderInterface
{
    ...
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\RequestFormDataHandler;
