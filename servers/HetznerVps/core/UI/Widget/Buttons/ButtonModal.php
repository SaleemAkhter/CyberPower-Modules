...
use \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\Modals\ExampleModal;
...
class ButtonModal extends BaseContainer implements AjaxElementInterface
{
    ...
    public function setModal($modal)
    {
        ...
        $this->modal = $modal;
        if ($modal instanceof \ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\AjaxElementInterface)
        {
