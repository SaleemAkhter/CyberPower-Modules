...
namespace ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable;

use \ModulesGarden\Servers\HetznerVps\Core\UI\Builder\BaseContainer;
use \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\DataProviders;
 ...
 * @author inbs
 */
class DataTable extends BaseContainer implements \ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\VSortable;
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\TableLength;
    use \ModulesGarden\Servers\HetznerVps\Core\UI\Traits\Datatable\Filters;
    ...
    */
    ...
    public function setData(\ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\DataSetInterface $data)
    {
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\Servers\HetznerVps\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
