...
use \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\DataProviders\DataProvider;
...
class Column
{
    ...
    public function setFilter(\ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\Filters $filter)
    {
        $this->filter = $filter;
