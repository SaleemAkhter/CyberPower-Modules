...
use \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\Servers\HetznerVps\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
    ...
    {
        return $this->query->getData($availableCols);
    }
