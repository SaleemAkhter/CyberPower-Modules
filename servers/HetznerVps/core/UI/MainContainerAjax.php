...
use \ModulesGarden\Servers\HetznerVps\Core\UI\Builder\Config;
use \ModulesGarden\Servers\HetznerVps\Core\Helper;
use \ModulesGarden\Servers\HetznerVps\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\Servers\HetznerVps\Core\Helper\sl('request')->get('index');
    ...
    public function addElement($element)
    {
        ...
        if (!isset($this->ajaxElements[$id]))
        {
            ...
            if ($element instanceof \ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\AjaxElementInterface)
            {
    ...
    public function addAjaxElement(\ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
    ...
    public function getAjaxResponse()
    {
        ...
        foreach ($this->ajaxElements as $aElem)
        {
            ...
            if ($this->namespaceAjax === $aElem->getNamespace())
            {
                ...
                if ($response instanceof \ModulesGarden\Servers\HetznerVps\Core\UI\Interfaces\ResponseInterface)
                {
