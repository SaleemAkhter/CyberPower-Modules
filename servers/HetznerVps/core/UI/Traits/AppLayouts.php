...
use \ModulesGarden\Servers\HetznerVps\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\Servers\HetznerVps\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
