...
class Response extends SymfonyRespose
{
    ...
    /**
     * @param $responseResolver \ModulesGarden\Servers\HetznerVps\Core\App\Controllers\ResponseResolver
     */
    ...
    public function returnClientAddon($vars, $path, $fileName)
    {
        return [
            ...
            'templatefile' => str_replace(\ModulesGarden\Servers\HetznerVps\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
    ...
    public function returnClientProvisioning($vars, $path, $fileName)
    {
        ...
        return [
            $templateVarName => str_replace(\ModulesGarden\Servers\HetznerVps\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
                '', $path . DIRECTORY_SEPARATOR . $fileName),
