...
use ModulesGarden\Servers\HetznerVps\Core\Events\Dispatcher;
...
use ModulesGarden\Servers\HetznerVps\Core\Logger\Entity;

if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\json'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\response'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\Servers\HetznerVps\Core\Http\Response
     */
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\cache'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\Servers\HetznerVps\Core\Interfaces\CacheManagerInterface
     */
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\redirect'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\redirectByUrl'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\t'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\errorLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\successLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\infoLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\criticalLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\debugLog'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\sl'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\di'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\isAdmin'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\getAdminDirName'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\getModuleName'))
{
    ...
    function getModuleName()
    {
        ...
        if (isAdmin())
        {
            $data = $request->get('module', $request->query->get('module', 'HetznerVps'));
            return isset($data) ? $data : '';
        }

        $data = $request->get('m', $request->query->get('m', 'HetznerVps'));
        return isset($data) ? $data : '';
    }
}

if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\view'))
{

    /**
     * main View Controler
     * 
     * @return \ModulesGarden\Servers\HetznerVps\Core\UI\View
     */
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\viewIntegrationAddon'))
{
    /**
     * View Integration Addon Controler
     *
     * @return \ModulesGarden\Servers\HetznerVps\Core\UI\ViewIntegrationAddon
     */
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\convertStringToNamespace'))
{
...
if (!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\getRequest'))
{
    function getRequest()
    {
        return sl(\ModulesGarden\Servers\HetznerVps\Core\Http\Request::class);
    }
}

if(!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\fire'))
{
    /**
     * Fire event!
     * @param $event
...
if(!function_exists('\ModulesGarden\Servers\HetznerVps\Core\Helper\queue'))
{
