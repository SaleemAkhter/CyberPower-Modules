 ...
 */
class Product extends \ModulesGarden\Servers\HetznerVps\Core\Models\Whmcs\Product
{
    /**
     *
    ...
    {
        return $this->hasOne('\ModulesGarden\Servers\HetznerVps\App\Models\ProductConfiguration', 'product_id', 'id');
    }
