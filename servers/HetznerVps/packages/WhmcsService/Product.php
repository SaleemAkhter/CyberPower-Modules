...
use ModulesGarden\Servers\HetznerVps\Core\Models\ProductSettings\Repository;
...
use ModulesGarden\Servers\HetznerVps\Packages\WhmcsService\Traits\CustomFieldsConfig;
...
class Product
{
    ...
    {
        if (!class_exists('\ModulesGarden\Servers\HetznerVps\App\Config\Packages\WhmcsService')) {
            return null;
        }
