...
add_hook('AdminProductConfigFieldsSave', 1, function($vars) {
    ...
    if ($vars['servertype']=='kametera' && $_REQUEST["packageconfigoption"][1] == "on")
    {
...
if(isset($vars['templatefile']) && $vars['templatefile']=='configureproduct' && isset($vars['productinfo'],$vars['productinfo']['module']) && $vars['productinfo']['module']=="AwsEc2"){
