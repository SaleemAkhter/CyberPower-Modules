...
class Home extends AbstractClientController
{
    ...
    {
        return  ((isset($_SESSION['resellerloginas']) && !empty($_SESSION['resellerloginas'])) || (isset($_SESSION['adminloginas']) && !empty($_SESSION['adminloginas'])));
    ...
    public function index()
    {
        ...
        if(!isset($_GET['hostingId']) && isset($_GET['id'])){
            return redir(['m'=>'WordpressManager','id'=>$_GET['id'],'hostingId'=>$_GET['id']], 'index.php');
        }
        $this->loadRequestObj();
