...
/**
 * Description of PluginItemAddMassForm
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class AddMassForm extends BaseForm implements AdminArea
{
    ...
    {
        $this->setConfirmMessage('confirmPluginPackageItemAddMass', ['title' => null]);
    }
}
