...
namespace ModulesGarden\WordpressManager\App\UI\Admin\InstanceImage\Fields;
 ...
 */
class Installation extends \ModulesGarden\WordpressManager\Core\UI\Widget\Forms\AjaxFields\SelectRemoteSearch implements AdminArea
{
    protected $id    = 'installation_id';
    protected $name  = 'installation_id';
    protected $title = 'installation_id';
