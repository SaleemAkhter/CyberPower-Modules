...
namespace ModulesGarden\WordpressManager\App\UI\Admin\ThemePackages\Providers;
...
class ThemePackageProvider extends BaseModelDataProvider implements AdminArea
{
    ...
    {
        parent::__construct(ThemePackage::class);
    }
    ...
    public function enableMass()
    {
        ...
        return (new HtmlDataJsonResponse())->setMessageAndTranslate('The selected theme packages have been enabled successfully');
    }
    ...
    public function disableMass()
    {
        ...
        return (new HtmlDataJsonResponse())->setMessageAndTranslate('The selected theme packages have been disabled successfully');
    }
    ...
    public function deleteMass()
    {
        ...
        return (new HtmlDataJsonResponse())->setMessageAndTranslate('The selected theme packages have been deleted successfully');
    }
    ...
    public function delete()
    {
        ...
        return (new HtmlDataJsonResponse())->setMessageAndTranslate('Theme package :name: has been deleted successfully');
    }
}
