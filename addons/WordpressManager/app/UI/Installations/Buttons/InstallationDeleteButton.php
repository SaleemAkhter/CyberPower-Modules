 ...
 */
class InstallationDeleteButton extends ButtonMassAction implements ClientArea
{
    use \ModulesGarden\WordpressManager\Core\UI\Widget\Sidebar\SidebarTrait;
    protected $title ='installationDeleteButton';
    ...
    {
        $this->initIds('installationDeleteButton');
        $this->initLoadModalAction(new InstallationDeleteModal());        
        $this->switchToRemoveBtn();
    }
    public function switchToRemoveBtn()
    {
        $this->replaceClasses(['lu-btn lu-btn--danger text-white']);
