...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginInstallModal;
 ...
 */
class PluginInstallButton extends ButtonDataTableModalAction  implements ClientArea
{
    ...
    {
        $this->initIds('pluginInstallButton');
        $this->initLoadModalAction(new PluginInstallModal());
    }
}
