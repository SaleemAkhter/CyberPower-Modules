...
use ModulesGarden\WordpressManager\App\UI\Installations\Modals\PluginDeleteMassModal;
 ...
 */
class PluginDeleteMassButton extends ButtonMassAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-delete';

    public function initContent()
    {   
        $this->initIds('pluginDeleteMassButton');
        $this->initLoadModalAction(new PluginDeleteMassModal());
