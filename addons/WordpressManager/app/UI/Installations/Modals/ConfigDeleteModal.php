...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\ConfigDeleteForm;
 ...
 */
class ConfigDeleteModal extends ModalConfirmDanger implements ClientArea
{

    public function initContent()
    {
        $this->initIds('ConfigDeleteModal');
        $this->addForm(new ConfigDeleteForm());
    }
}
