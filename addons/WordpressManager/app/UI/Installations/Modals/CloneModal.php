...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\CloneForm;
 ...
 */
class CloneModal extends BaseEditModal implements ClientArea
{
    protected $id    = 'cloneModal';
    protected $name  = 'cloneModal';
    protected $title = 'cloneModal';
