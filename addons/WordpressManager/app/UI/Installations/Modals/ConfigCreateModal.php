...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\ConfigCreateForm;
 ...
 */
class ConfigCreateModal extends BaseEditModal implements ClientArea
{

    public function initContent()
    {
        $this->initIds('configCreateModal');
        $this->addForm(new ConfigCreateForm());
    }
}
