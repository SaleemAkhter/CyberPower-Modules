...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\PluginInstallForm;
 ...
 */
class PluginInstallModal extends ModalConfirmSuccess implements ClientArea
{

    public function initContent()
    {
        $this->initIds('pluginInstallModal');
        $this->addForm(new PluginInstallForm());
    }
}
