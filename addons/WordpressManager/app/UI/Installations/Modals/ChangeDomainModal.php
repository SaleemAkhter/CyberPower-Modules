...
use ModulesGarden\WordpressManager\App\UI\Installations\Forms\ChangeDomainForm;
 ...
 */
class ChangeDomainModal extends BaseEditModal implements ClientArea
{

    public function initContent()
    {
        $this->initIds('changeDomainModal');
        $this->addForm(new ChangeDomainForm);
    }
}
