 ...
 */
class DisableMassForm extends BaseForm implements ClientArea
{
    ...
    {
        $this->initIds('themeDisableMassForm');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmThemeDisableMass', ['title' => null]);
    }
}
