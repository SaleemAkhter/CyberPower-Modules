...
class UserProvider extends BaseDataProvider implements ClientArea
{
    ...
    public function read()
    {
        ...
        $this->user = ($this->subModule()->setUsername($username)->getWpCli($this->getInstallation()))->user();
    ...
    public function create()
    {
        ...
        $username=Helper\loggedinUsername();
        $this->setInstallation(Installation::find($this->request->get('wpid')));
        $user = ($this->subModule()->setUsername($username)->getWpCli($this->getInstallation()))->user();
