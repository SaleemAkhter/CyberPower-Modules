 ...
 */
class PluginDeactivateMassForm extends BaseForm implements ClientArea
{

    protected function getDefaultActions()
    {
        return ['deactivateMass'];
    }

    public function initContent()
    {
        $this->initIds('pluginDeactivateMassForm');
        $this->setFormType('deactivateMass');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmPluginDeactivateMass', ['title' => null]);
    }
}
