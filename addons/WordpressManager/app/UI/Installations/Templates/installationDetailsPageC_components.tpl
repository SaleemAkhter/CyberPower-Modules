                                    ...
                                    <div class="lu-form-group">
                                     ...
                                     <div class="lu-row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="radio" value="" :id="'auto_upgrade_themes_disabled_'+item.id" name="auto_upgrade_themes" :checked="(typeof item.additionalData.auto_upgrade_themes !='undefined' && item.additionalData.auto_upgrade_themes=='off')" @change="saveSiteConfig('auto_upgrade_themes_disabled_'+item.id,item.id,$event)">
                                    ...
                                    <div class="lu-row">
                                        <div class="lu-col-12 lu-col-lg-6">
                                            <div class="lu-form-group">
                                                ...
                                                <br>
                                               <input type="radio" value="0" :id="'disable_wp_cron_enabled_'+item.id" name="disable_wp_cron" :checked="(typeof item.additionalData.disable_wp_cron !='undefined' && item.additionalData.disable_wp_cron!=1)" @change="saveSiteConfig('disable_wp_cron_enabled_'+item.id,item.id,$event)">
                                        ...
                                        <div class="lu-col-12 lu-col-lg-6 wpbtnthreerow">
                                            <div class="lu-row">
                                                <div class="lu-col-12">
                                                    {foreach from=$rawObject->getButtons() key=buttonKey item=buttonValue}
