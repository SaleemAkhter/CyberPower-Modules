...
/**
 * Description of PluginBlockMassButton
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class PluginBlockMassButton extends  ButtonMassAction implements AdminArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-plus';
    public function initContent()
    {     
        
        $this->initIds('PluginBlockMassButton');
        $this->initLoadModalAction(new PluginBlockMassModal());
    }
}
