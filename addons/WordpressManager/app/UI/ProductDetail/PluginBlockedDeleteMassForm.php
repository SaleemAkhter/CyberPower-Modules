...
/**
 * Description of PluginBlockedDeleteMassForm
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class PluginBlockedDeleteMassForm extends BaseForm implements AdminArea
{
    ...
    {
        $this->initIds('pluginBlockedDeleteMassForm');
    ...
    protected function initFields()
    {
        ...
        $this->setConfirmMessage('confirmPluginBlockedMass', ['title' => null]);
    }
}
