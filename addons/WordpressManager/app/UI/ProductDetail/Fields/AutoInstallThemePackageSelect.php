 ...
 */
class AutoInstallThemePackageSelect extends Select implements AdminArea
{
    ...
    public function prepareAjaxData()
    {
        ...
        foreach(  ThemePackage::select('name', 'id')->get() as $row){
            $options[] =[
                'key'    => $row->id,
        ...
        $this->setSelectedValue($model->getAutoInstallThemePackages());
    }
