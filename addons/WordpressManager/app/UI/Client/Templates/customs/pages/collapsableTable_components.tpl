<script type="text/x-template" id="t-mg-collapsableTable-{$elementId|strtolower}"
    ...
    <div class="lu-widget widgetActionComponent vueDatatableTable"  id="{$rawObject->getId()}"  namespace="{$namespace}" index="{$rawObject->getIndex()}" actionid="{$rawObject->getIndex()}">
        ...
        <div class="lu-widget__body">
            <div class="lu-t-c  datatableLoader" id="{$elementId}" data-table-container data-check-container>
                ...
                <div class="panel-group" role="tablist" v-for="dataRow in dataRows" {literal}:actionid="dataRow.id"{/literal} role="row">
                    <div class="panel panel-default">
                      <div class="panel-heading" role="tab" id="collapseListGroupHeading1">
                        <div class="wp-info" id="ins_26_68133">
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <a href="http://site2.dmo.website" class="title d-block" target="_blank" id="url_26_68133" style="text-decoration:none;">http://site2.dmo.website</a>
                                </div>
                                <div class="col-12 col-md-2">
                                    <span class="title d-block">WPM</span>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="row mt-2 mt-md-0">
                                        <div class="col-6 col-md-7">
                                            <a class="mr-1" href="index.raw?act=sign_on&amp;insid=26_68133&amp;autoid=iapssvfqf2hebfsescvwoyy3jfu19ocn" target="_blank" data-toggle="tooltip" data-html="true" title="" data-original-title="Login as admin user in WordPress">
                                                <input type="button" name="login_button" class="form-btn form-btn-action active " id="login_button" value="Login" style="cursor:pointer;">
                                            </a><a href="javascript:void(0);" onclick="change_password_modal('26_68133')"> Manage Users </a></div>

                                        <div class="col-5 col-md-4">
                                            <span class="success-badge heading-badge d-block" id="toggle_26_68133" onclick="toggle_ins_form($(this))" style="cursor:pointer; text-align:center;">Up to date</span>
                                        </div>

                                        <div class="col-1 col-md-1">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" :href="'col'+dataRow.id" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            </a>
                                            <i class="fas fa-chevron-right pull-right" id="toggle_26_68133" style="vertical-align:middle; font-size:1.4em; transform:rotate(90deg); cursor:pointer; padding:7px;" onclick="toggle_ins_form($(this))"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                      ...
                      :id="'col'+dataRow.id" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="collapseListGroupHeading1" aria-expanded="true" style="">
                        <ul class="list-group">
