...
/**
 * Description of InstanceImageModal
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class InstanceImageModal extends BaseEditModal implements ClientArea
{

    public function initContent()
    {
        $this->initIds('instanceImageModalCreate');
        $this->addForm(new InstanceImageForm);
    }
}
