...
/**
 * Description of InstallButton
 *
 * @author Pawel Kopec <pawelk@modulesgardne.com>
 */
class InstallButton extends ButtonDataTableModalAction implements ClientArea
{
    protected $icon  = 'lu-btn__icon lu-zmdi lu-zmdi-plus';

    public function initContent()
    {
        $this->initIds('installButton');
        $this->initLoadModalAction(new InstallModal());
    }
}
