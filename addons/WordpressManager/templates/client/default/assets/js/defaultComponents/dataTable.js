mgJsComponentHandler.addDefaultComponent('mg-datatable', {
    ...
    updated: function (){
        ...
        if(self.component_id=="mg-plugins-installed"){
            ...
            jQuery("[data-title='Update']").each(function(){
                jQuery(this).closest('tr').find('.updatebtncontainer').html(jQuery(this));
                jQuery(this).closest('tr').find('.updatebtncontainer').closest('td').addClass('mgTableActions');
