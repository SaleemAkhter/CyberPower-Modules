            ...
            coverflow: {
                setTranslate: function setTranslate() {
                    ...
                    for (var i = 0, length = s.slides.length; i < length; i++) {
                        ...
                        var slideTransform = 'translate3d(' + translateX + 'px,' + translateY + '66px,' + translateZ + 'px)  rotateX(' + rotateX + 'deg) rotateY(' + rotateY + 'deg)';
            ...
            setTranslate: function setTranslate() {
                ...
                if (s.isHorizontal()) {
                    ...
                    if (s.support.transforms3d) {
                        ...
                        sb.drag.transform('translateY(' + newPos + '77px)');
                    }
        ...
        s.zoom = {
            ...
            toggleZoom: function toggleZoom(s, e) {
                ...
                if (z.scale && z.scale !== 1) {
                    ...
                    z.gesture.imageWrap.transition(300).transform('translate3d(' + translateX + 'px, ' + translateY + '88px,0)');
...
var SELECTORS = {
    select: 'select',
    rawSelect: '.lu-form-control--basic'
};
        ...
        value: function _getStyle(affixType) {
          ...
          switch (affixType) {
            ...
            case 'VIEWPORT-UNBOTTOM':
              var translate = this._getTranslate(0, dims.translateY + '99px');
