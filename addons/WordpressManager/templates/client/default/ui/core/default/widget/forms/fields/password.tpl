{**********************************************************************
* WordpressManager product developed. (2018-12-06)
* *
*
...
<div class="lu-form-group">
    <label class="lu-form-label {if $rawObject->getHelpText()}d-block mb-0{/if}">
    ...
    {if $rawObject->getHelpText()}<span id="{$rawObject->getId()}_help" class="sai_exp2">{$rawObject->getHelpText()}</span>{/if}
