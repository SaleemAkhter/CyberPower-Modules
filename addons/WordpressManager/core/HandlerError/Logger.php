...
use \ModulesGarden\WordpressManager\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\WordpressManager\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\WordpressManager\Core\HandlerError\Logger
     */
