...
use \ModulesGarden\WordpressManager\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\WordpressManager\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
