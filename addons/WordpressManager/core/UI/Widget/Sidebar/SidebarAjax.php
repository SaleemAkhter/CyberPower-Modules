...
/* * ********************************************************************
 * WordpressManager product developed. (Nov 19, 2018)
 * *
 *
 ...
 */
class SidebarAjax extends Sidebar implements \ModulesGarden\WordpressManager\Core\UI\Interfaces\AjaxElementInterface
{
    ...
    protected function parseProvidedData()
    {
        ...
        foreach ($this->ajaxMenuElements as $mItem)
        {
            $data[] = [
                ...
                'title' => html_entity_decode($this->lang->tr($this->id, $mItem->getTitle()), ENT_QUOTES)
            ];
        }
