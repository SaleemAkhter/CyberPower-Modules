...
ALTER TABLE `WordpressManager_Installations` ADD `site_name` VARCHAR(500) NULL AFTER `relation_id`;
ALTER TABLE `WordpressManager_Installations` ADD `additional_data` TEXT NULL AFTER `relation_id`;
