...
use ModulesGarden\WordpressManager\Core\App\Controllers\Instances\Http\Integration;
...
class HookIntegratorView
{
    ...
    /**
     * @var null|string|\ModulesGarden\WordpressManager\Core\UI\View
     * integration data
     */
    protected $view = null;
    ...
    {
        if ($this->view instanceof \ModulesGarden\WordpressManager\Core\UI\View)
        {
