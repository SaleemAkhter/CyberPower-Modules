...
if(!function_exists('\ModulesGarden\WordpressManager\Core\Helper\loggedinUsername'))
{
    function loggedinUsername()
    {
        ...
        $username='';
        if(isset($_SESSION['resellerloginas'][$serviceid])){
            $username=$_SESSION['resellerloginas'][$serviceid];
        }
        if(isset($_SESSION['adminloginas'][$serviceid]) && $_SESSION['adminloginasrole'][$serviceid]!='user'){
            $username=$_SESSION['adminloginas'][$serviceid];
        }elseif(!isset($_SESSION['resellerloginas'][$serviceid]) && (isset($_SESSION['adminloginas'][$serviceid]) && $_SESSION['adminloginasrole'][$serviceid]=='user')){
            $username=$_SESSION['adminloginas'][$serviceid];
        }
        return $username;
    }
