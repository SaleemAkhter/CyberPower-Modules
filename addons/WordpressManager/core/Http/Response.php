...
use ModulesGarden\WordpressManager\Core\Http\View\Smarty;
...
use ModulesGarden\WordpressManager\Core\Http\View\MainMenu;
...
class Response extends SymfonyRespose
{
    ...
    /**
     * @param $responseResolver \ModulesGarden\WordpressManager\Core\App\Controllers\ResponseResolver
     */
    ...
    public function returnClientAddon($vars, $path, $fileName)
    {
        return [
            ...
            'vars' => $vars,
            'templatefile' => str_replace(\ModulesGarden\WordpressManager\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
    ...
    public function returnClientProvisioning($vars, $path, $fileName)
    {
        ...
        return [
            $templateVarName => str_replace(\ModulesGarden\WordpressManager\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
                '', $path . DIRECTORY_SEPARATOR . $fileName),
    ...
    {
        $requirementsHandler = new \ModulesGarden\WordpressManager\Core\App\Requirements\Checker();
