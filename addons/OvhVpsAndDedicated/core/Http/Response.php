...
use ModulesGarden\OvhVpsAndDedicated\Core\Http\View\Smarty;
...
use ModulesGarden\OvhVpsAndDedicated\Core\Http\View\MainMenu;
...
use ModulesGarden\OvhVpsAndDedicated\Core\Helper\WhmcsVersionComparator;
...
{
    use \ModulesGarden\OvhVpsAndDedicated\Core\Traits\Template;
    ...
    /**
     * @param $responseResolver \ModulesGarden\OvhVpsAndDedicated\Core\App\Controllers\ResponseResolver
     */
    ...
    public function returnClientAddon($vars, $path, $fileName)
    {
        return [
            'vars' => $vars,
            'templatefile' => str_replace(\ModulesGarden\OvhVpsAndDedicated\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
    ...
    public function returnClientProvisioning($vars, $path, $fileName)
    {
        ...
        return [
            $templateVarName => str_replace(\ModulesGarden\OvhVpsAndDedicated\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR,
                '', $path . DIRECTORY_SEPARATOR . $fileName),
    ...
    {
        $requirementsHandler = new \ModulesGarden\OvhVpsAndDedicated\Core\App\Requirements\Checker();
