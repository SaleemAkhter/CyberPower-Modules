...
namespace ModulesGarden\OvhVpsAndDedicated\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\OvhVpsAndDedicated\Core\ModuleConstants;
use ModulesGarden\OvhVpsAndDedicated\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
     ...
     * @param string $key
     * @return $this
     * @throws \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Exceptions\MGModuleException
     */
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
