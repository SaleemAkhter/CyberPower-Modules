...
class Product extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\OvhVpsAndDedicated\Core\Models\Whmcs\ProductGroup", "gid");
    }

    public function upgrades()
    {
        return $this->hasMany("ModulesGarden\OvhVpsAndDedicated\Core\Models\Whmcs\ProductUpgrade", "product_id");
    }
}
