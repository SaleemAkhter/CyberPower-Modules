...
class HostingAddon extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\OvhVpsAndDedicated\Core\Models\Whmcs\Addon", "addonid");
    }

    public function hosting()
    {
        return $this->belongsTo("ModulesGarden\OvhVpsAndDedicated\Core\Models\Whmcs\Hosting", "hostingid");
    }
