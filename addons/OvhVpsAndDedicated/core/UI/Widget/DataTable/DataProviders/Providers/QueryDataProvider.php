...
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
