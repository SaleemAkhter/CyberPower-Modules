...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\DataProviders;
...
{
    const FILTR_BY_DATE           = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\Date';
    const FILTR_BY_RAGE           = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\Rage';
    const FILTR_BY_RAGE_DATE      = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\RageDate';
    const FILTR_BY_SELECT         = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\Select';
    const FILTR_BY_TEXT           = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\Text';
    const FILTR_BY_YESNO          = '\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\Filters\YesNo';
    const SORT_ASC                = 'ASC';
