...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable;

use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Builder\BaseContainer;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\DataTable\DataProviders;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\ResponseTemplates;
use \ModulesGarden\OvhVpsAndDedicated\Core\DependencyInjection\DependencyInjection;
 ...
 * @author inbs
 */
class DataTable extends BaseContainer implements \ModulesGarden\OvhVpsAndDedicated\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\VSortable;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\TableLength;
    ...
    public function setData(\ModulesGarden\OvhVpsAndDedicated\Core\UI\Interfaces\DataSetInterface $data)
    {
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
