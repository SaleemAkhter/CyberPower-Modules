...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Graphs\Settings;
...
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Forms\Fields\Number;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Forms\Fields\Select2vueByValueOnly;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Forms\Fields\ColorPicker;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Graphs\EmptyGraph;
...
class SettingForm extends BaseForm
{
    ...
    protected $providerClass    = 'ModulesGarden\OvhVpsAndDedicated\Core\UI\Widget\Graphs\Settings\SettingDataProvider';
