...
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\OvhVpsAndDedicated\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
