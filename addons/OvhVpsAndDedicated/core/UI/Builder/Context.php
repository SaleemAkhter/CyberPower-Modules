...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI\Builder;

use ModulesGarden\OvhVpsAndDedicated\Core\ServiceLocator;
use ModulesGarden\OvhVpsAndDedicated\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Title;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Template;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Searchable;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Buttons;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Icon;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\VueComponent;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\ACL;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\Alerts;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\WidgetView;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\ContainerElements;
    use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Traits\WhmcsParams;
    ...
    /**
     * @param \ModulesGarden\OvhVpsAndDedicated\Core\UI\Builder\Context $object
     * @return string
     */
