...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI;

use \ModulesGarden\OvhVpsAndDedicated\Core\Http\Request;
use \ModulesGarden\OvhVpsAndDedicated\Core\DependencyInjection;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Builder\Config;
use \ModulesGarden\OvhVpsAndDedicated\Core\Helper;
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\OvhVpsAndDedicated\Core\Helper\sl('request')->get('index');
    ...
    public function addElement($element)
    {
        ...
        if (!isset($this->ajaxElements[$id]))
        {
            ...
            if ($element instanceof \ModulesGarden\OvhVpsAndDedicated\Core\UI\Interfaces\AjaxElementInterface)
            {
    ...
    public function addAjaxElement(\ModulesGarden\OvhVpsAndDedicated\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
    ...
    public function getAjaxResponse()
    {
        ...
        foreach ($this->ajaxElements as $aElem)
        {
            ...
            if ($this->namespaceAjax === $aElem->getNamespace())
            {
                ...
                if ($response instanceof \ModulesGarden\OvhVpsAndDedicated\Core\UI\Interfaces\ResponseInterface)
                {
