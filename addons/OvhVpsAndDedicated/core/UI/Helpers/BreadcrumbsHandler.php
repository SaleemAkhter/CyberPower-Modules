...
namespace ModulesGarden\OvhVpsAndDedicated\Core\UI\Helpers;
...
class BreadcrumbsHandler
{
    ...
    {
        $this->breadcrumbs[] = new \ModulesGarden\OvhVpsAndDedicated\Core\UI\Helpers\Breadcrumb(
    ...
    public function loadDefault()
    {
        ...
        $router = new \ModulesGarden\OvhVpsAndDedicated\Core\App\Controllers\Router();
        if ($this->isAdmin())
        {
