...
use \ModulesGarden\OvhVpsAndDedicated\Core\UI\View;
...
class ResponseResolver
{
    ...
    {
        /**
         * @var $this->response \ModulesGarden\OvhVpsAndDedicated\Core\UI\View
         */
    ...
    /**
     * resolve \ModulesGarden\OvhVpsAndDedicated\Core\Http\JsonResponse
     */
    public function resolveJson()
    {
        $this->cleanOutputBuffer();
        /**
         * @var \ModulesGarden\OvhVpsAndDedicated\Core\Http\JsonResponse
         */
        $this->response->send();
        die();
    }
    ...
    {
        /**
         * @var \ModulesGarden\OvhVpsAndDedicated\Core\Http\RedirectResponse
         */
