 ...
 */
class Activate extends \ModulesGarden\OvhVpsAndDedicated\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
    ...
    public function execute($params = [])
    {
        try
        {
            ...
            $return = ServiceLocator::call(\ModulesGarden\OvhVpsAndDedicated\Core\Configuration\Addon\Activate\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\OvhVpsAndDedicated\Core\Configuration\Addon\Activate\After::class)->execute($return);
