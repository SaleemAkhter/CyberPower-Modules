...
namespace ModulesGarden\OvhVpsAndDedicated\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\OvhVpsAndDedicated\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\OvhVpsAndDedicated\Core\FileReader\|\ModulesGarden\OvhVpsAndDedicated\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\OvhVpsAndDedicated\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\OvhVpsAndDedicated\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\OvhVpsAndDedicated\Core\DependencyInjection\DependencyInjection::call($requirement);
