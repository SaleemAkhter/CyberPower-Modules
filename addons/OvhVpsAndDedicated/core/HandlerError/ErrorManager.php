...
namespace ModulesGarden\OvhVpsAndDedicated\Core\HandlerError;
...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\OvhVpsAndDedicated\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Model\Warning $warning)
    {
