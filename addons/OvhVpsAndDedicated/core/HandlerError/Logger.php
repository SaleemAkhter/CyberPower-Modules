...
use \ModulesGarden\OvhVpsAndDedicated\Core\Interfaces\LoggerInterface;
...
{
    /**
     * @var \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\OvhVpsAndDedicated\Core\HandlerError\Logger
     */
