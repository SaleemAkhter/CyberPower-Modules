{**********************************************************************
* CloudBilling product developed. (2017-10-30)
* *
*
...
<div class="lu-form-group">
    ...
    <select 
        ...
        {if $rawObject->isMultiple()}data-options="removeButton:true; resotreOnBackspace:true; dragAndDrop:true; maxItems: null; create: {if $rawObject->isDynamicCreateEnabled()}true{else}false{/if}" multiple="multiple"{/if}
        {if $rawObject->getPlaceholder()}placeholder="{$MGLANG->translate('placeholder', $rawObject->getPlaceholder())}"{/if}
    >
