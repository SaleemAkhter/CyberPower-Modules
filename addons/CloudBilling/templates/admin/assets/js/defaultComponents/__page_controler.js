    ...
    this.initModal = function(id, namespace, index, event, dataLoaded){
        ...
        if (typeof dataLoaded.registrations !== 'undefined') {
            ...
            for (var key in dataLoaded.registrations) {
                ...
                let component = mgJsComponentHandler.createComponentAndReturn(key.toLowerCase(), dataLoaded.registrations[key]);
                components[component.name] = component.component;
            }
            
            let config = self.getVueModalAppInits();
            config.components = components;
            
            self.modalInstance =  new Vue(config);
        }
        else
        {
