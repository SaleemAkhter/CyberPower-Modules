            ...
            <div class="lu-navbar__nav">
                <ul class="lu-nav lu-nav--h lu-is-left">
                    {foreach from=$menu key=catName item=category}
                        {if $category.submenu}
                            <li class="lu-nav__item lu-has-dropdown {if $currentPageName|strtolower === $catName|strtolower}is-active{/if}">
                                    ...
                                    <div class="lu-row">
                                        ...
                                        <div class="lu-col-md-12" style="margin-top: 35px; margin-bottom: 15px; text-align: center;">
                                            <div class="lu-msg__actions">
                                                <a class="lu-btn lu-btn--lg lu-btn--default" href="addonmodules.php?module=DirectAdminExtended" style="    background-color: #f66e6e !important; color: #fff">
