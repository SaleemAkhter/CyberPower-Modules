...
namespace ModulesGarden\DirectAdminExtended\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\DirectAdminExtended\Core\ModuleConstants;
use ModulesGarden\DirectAdminExtended\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
    ...
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\DirectAdminExtended\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
