...
namespace ModulesGarden\DirectAdminExtended\Core\HandlerError\Exceptions;

use ModulesGarden\DirectAdminExtended\Core\ServiceLocator;
use ModulesGarden\DirectAdminExtended\Core\HandlerError\ErrorManager;
...
class Exception extends \Exception
{
     ...
     * 
     * @var type \ModulesGarden\DirectAdminExtended\Core\HandlerError\ErrorCodes\ErrorCode
     */
