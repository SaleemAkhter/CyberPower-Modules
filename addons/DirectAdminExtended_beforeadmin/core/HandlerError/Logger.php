...
use \ModulesGarden\DirectAdminExtended\Core\Interfaces\LoggerInterface;
use \ModulesGarden\DirectAdminExtended\Core\HandlerError\ErrorCodes\ErrorCodesLib;
use \ModulesGarden\DirectAdminExtended\Core\HandlerError\Exceptions\Exception;
...
{
    /**
     * @var \ModulesGarden\DirectAdminExtended\Core\HandlerError\Logger
     */
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\DirectAdminExtended\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\DirectAdminExtended\Core\HandlerError\Logger
     */
