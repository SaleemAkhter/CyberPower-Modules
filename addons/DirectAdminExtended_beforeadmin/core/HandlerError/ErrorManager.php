...
namespace ModulesGarden\DirectAdminExtended\Core\HandlerError;
...
class ErrorManager
{
    ...
    /**
     * @var \ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Error[]
     */
    protected static $errors = [];
    
    /**
     * @var \ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Warning[]
     */
    protected static $warnings = [];

    /**
     * @var \ModulesGarden\DirectAdminExtended\Core\HandlerError\WhmcsLogsHandler
     */
    protected static $whmcsLogger;


    /**
     * @var \ModulesGarden\DirectAdminExtended\Core\Interfaces\LoggerInterface
     */
    protected $logger;
    ...
    /**
     * @return \ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Error
     */
    ...
    /**
     * @return \ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Warning[]
     */
    ...
    /**
     * @return \ModulesGarden\DirectAdminExtended\Core\HandlerError\WhmcsLogsHandler
     */
    ...
    {
        return new \ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Error($class, $massage, $trace);
    }
    ...
    protected function _addError(\ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Error $error)
    {
    ...
    protected function _addWarning(\ModulesGarden\DirectAdminExtended\Core\HandlerError\Model\Warning $warning)
    {
