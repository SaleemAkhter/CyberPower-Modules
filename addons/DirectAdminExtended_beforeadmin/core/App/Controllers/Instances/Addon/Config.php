...
use ModulesGarden\DirectAdminExtended\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\DirectAdminExtended\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\DirectAdminExtended\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\DirectAdminExtended\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\DirectAdminExtended\Core\Configuration\Addon\Config\After::class)->execute($return);
