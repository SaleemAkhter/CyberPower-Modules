...
namespace ModulesGarden\DirectAdminExtended\Core\App\Requirements;
...
{
    /** 
     * \ModulesGarden\DirectAdminExtended\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\DirectAdminExtended\Core\FileReader\|\ModulesGarden\DirectAdminExtended\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\DirectAdminExtended\Core\FileReader\Directory();
    ...
    {
        $fullPath = \ModulesGarden\DirectAdminExtended\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\DirectAdminExtended\Core\DependencyInjection\DependencyInjection::call($requirement);
