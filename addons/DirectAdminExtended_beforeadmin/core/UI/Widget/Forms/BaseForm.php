 ...
 */
class BaseForm extends BaseContainer implements \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface, \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\FormInterface
{

    use \ModulesGarden\DirectAdminExtended\Core\UI\Traits\Form;
    use \ModulesGarden\DirectAdminExtended\Core\UI\Traits\Fields;
    use \ModulesGarden\DirectAdminExtended\Core\UI\Traits\Sections;    
    use \ModulesGarden\DirectAdminExtended\Core\UI\Traits\FormDataProvider;
