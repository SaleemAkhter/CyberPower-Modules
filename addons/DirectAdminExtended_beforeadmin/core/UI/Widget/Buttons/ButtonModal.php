...
namespace ModulesGarden\DirectAdminExtended\Core\UI\Widget\Buttons;
...
use \ModulesGarden\DirectAdminExtended\Core\UI\Widget\Modals\ExampleModal;
...
class ButtonModal extends BaseContainer implements AjaxElementInterface
{
    ...
    public function setModal($modal)
    {
        ...
        $this->modal = $modal;
        if ($modal instanceof \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface)
        {
