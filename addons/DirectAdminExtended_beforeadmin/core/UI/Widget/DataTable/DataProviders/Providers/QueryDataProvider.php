...
use \ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\DataQuery;
use \ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\RawDataQuery;

/**
 *
 */
class QueryDataProvider extends \ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\DataProviders\DataProvider
{
    private $query   = null;
