...
{
    const FILTR_BY_DATE           = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\Date';
    const FILTR_BY_RAGE           = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\Rage';
    const FILTR_BY_RAGE_DATE      = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\RageDate';
    const FILTR_BY_SELECT         = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\Select';
    const FILTR_BY_TEXT           = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\Text';
    const FILTR_BY_YESNO          = '\ModulesGarden\DirectAdminExtended\Core\UI\Widget\DataTable\Filters\YesNo';
    const SORT_ASC                = 'ASC';
