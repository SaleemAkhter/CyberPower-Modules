...
use \ModulesGarden\DirectAdminExtended\Core\UI\Widget\Buttons\ModalActionButtons\BaseAcceptButton;
use \ModulesGarden\DirectAdminExtended\Core\UI\Widget\Buttons\ModalActionButtons\BaseCancelButton;
...
trait ModalActionButtons
{
    ...
    protected function addButtonToList($button)
    {
        ...
        if (!isset($this->actionButtons[$id]))
        {
            ...
            if ($button instanceof \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface)
            {
