...
namespace ModulesGarden\DirectAdminExtended\Core\UI;

use \ModulesGarden\DirectAdminExtended\Core\Http\Request;
use \ModulesGarden\DirectAdminExtended\Core\DependencyInjection;
use \ModulesGarden\DirectAdminExtended\Core\UI\Builder\Config;
use \ModulesGarden\DirectAdminExtended\Core\Helper;
use \ModulesGarden\DirectAdminExtended\Core\UI\Builder\Context;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\DirectAdminExtended\Core\Helper\sl('request')->get('index');
    ...
    public function addElement($element)
    {
        ...
        if (!isset($this->ajaxElements[$id]))
        {
            ...
            if ($element instanceof \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface)
            {
    ...
    public function addAjaxElement(\ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
    ...
    public function getAjaxResponse()
    {
        ...
        foreach ($this->ajaxElements as $aElem)
        {
            ...
            if ($this->namespaceAjax === $aElem->getNamespace())
            {
                ...
                if ($response instanceof \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\ResponseInterface)
                {
