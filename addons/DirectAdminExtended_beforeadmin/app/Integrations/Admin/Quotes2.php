...
namespace ModulesGarden\DirectAdminExtended\App\Integrations\Admin;

use \ModulesGarden\DirectAdminExtended\Core\Hook\AbstractHookIntegrationController;
...
class Quotes2 extends AbstractHookIntegrationController
{
    ...
    public function __construct()
    {
        $this->addIntegration(
            ...
            [\ModulesGarden\DirectAdminExtended\App\Http\Admin\Quotes::class, 'index2'],
            '.tablebg',
            self::TYPE_CUSTOM,
            'mgPrepareQuoteItems'
        );
