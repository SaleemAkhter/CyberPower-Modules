...
use \ModulesGarden\DirectAdminExtended\Core\UI\Helpers\AppLayoutConstants;
...
trait AppLayouts
{
    ...
    {
        return \ModulesGarden\DirectAdminExtended\Core\ModuleConstants::getTemplateDir() . DIRECTORY_SEPARATOR
