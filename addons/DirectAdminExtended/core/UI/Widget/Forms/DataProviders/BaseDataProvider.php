...
namespace ModulesGarden\DirectAdminExtended\Core\UI\Widget\Forms\DataProviders;

use \ModulesGarden\DirectAdminExtended\Core\UI\Interfaces\FormDataProviderInterface;
...
abstract class BaseDataProvider implements FormDataProviderInterface
{
    ...
    use \ModulesGarden\DirectAdminExtended\Core\UI\Traits\RequestFormDataHandler;
