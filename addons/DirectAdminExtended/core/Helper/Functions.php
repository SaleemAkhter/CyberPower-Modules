...
use ModulesGarden\DirectAdminExtended\Core\Events\Dispatcher;
...
use ModulesGarden\DirectAdminExtended\Core\Cache\CacheManager;
use ModulesGarden\DirectAdminExtended\Core\Logger\Entity;

if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\json'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\response'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\DirectAdminExtended\Core\Http\Response
     */
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\cache'))
{
    /**
     * @param array $data
     * @return \ModulesGarden\DirectAdminExtended\Core\Interfaces\CacheManagerInterface
     */
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\redirect'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\redirectByUrl'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\t'))
{
    /**
     * @param array $data
     * @return JsonResponse
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\errorLog'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\successLog'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\infoLog'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\criticalLog'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\debugLog'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\sl'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\di'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\isAdmin'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\getAdminDirName'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\getModuleName'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\view'))
{

    /**
     * main View Controler
     * 
     * @return \ModulesGarden\DirectAdminExtended\Core\UI\View
     */
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\viewIntegrationAddon'))
{
    /**
     * View Integration Addon Controler
     *
     * @return \ModulesGarden\DirectAdminExtended\Core\UI\ViewIntegrationAddon
     */
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\convertStringToNamespace'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\getRequest'))
{
    function getRequest()
    {
        return sl(\ModulesGarden\DirectAdminExtended\Core\Http\Request::class);
    }
}

if(!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\fire'))
{
    /**
     * Fire event!
     * @param $event
...
if(!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\dispatch'))
{
...
if (!function_exists('\ModulesGarden\DirectAdminExtended\Core\Helper\isAddon'))
{
    /**
     * @return bool
     */
