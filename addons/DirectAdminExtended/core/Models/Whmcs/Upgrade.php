...
class Upgrade extends EloquentModel
{
    ...
    public function hosting()
    {
        ...
        return $this->belongsTo("ModulesGarden\DirectAdminExtended\Core\Models\Whmcs\Hosting", "relid");
    }
    ...
    public function productFrom()
    {
        ...
        return $this->belongsTo("ModulesGarden\DirectAdminExtended\Core\Models\Whmcs\Product", "originalvalue");
    }
